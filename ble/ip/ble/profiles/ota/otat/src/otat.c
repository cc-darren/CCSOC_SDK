...
const uint8_t BLE_OTA_BASE_UUID_128[ATT_UUID_128_LEN] = {0x59, 0xFE, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
#else //for app 
const uint8_t BLE_OTA_BASE_UUID_128[ATT_UUID_128_LEN] = {0x50, 0xEA, 0xDA, 0x30, 0x88, 0x83, 0xB8, 0x9F, 0x60, 0x4F, 0x15, 0xF3, 0x01, 0x00, 0x40, 0x8E}; /**< Used vendor specific UUID. */
...
#ifdef BLE_OTA_BL_MODE_EN
    status = attm_svc_create_db_128(start_hdl, BLE_OTA_BASE_UUID_128, (uint8_t *)&cfg_flag, 
