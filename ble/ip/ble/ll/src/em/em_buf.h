 ...
 ****************************************************************************************
 */
__BLE_INLINE struct em_buf_tx_desc *em_buf_tx_desc_addr_get(uint16_t idx)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE struct em_desc_node *em_buf_tx_desc_node_get(uint16_t idx)
{
    // Pop a descriptor from the TX free list
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint8_t em_buf_rx_current_get(void)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE void em_buf_rx_current_set(uint8_t hdl)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint8_t em_buf_rx_next(uint8_t hdl)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE struct em_desc_node* em_buf_tx_desc_alloc(void)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE struct em_buf_node *em_buf_tx_alloc(void)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE struct em_buf_tx_desc *em_buf_tx_desc_get(uint16_t idx)
{
    // Pop a descriptor from the TX free list
    return(&em_buf_env.tx_desc[idx]);
}
 ...
 ****************************************************************************************
 */
__BLE_INLINE void em_buf_tx_desc_free(struct em_desc_node *desc)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE void em_buf_tx_buff_free(int idx)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE struct em_desc_node *em_buf_node_get(uint16_t idx)
{
    // Pop a descriptor from the TX free list
    return(&em_buf_env.tx_desc_node[idx]);
}
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint16_t em_read_8(uint16_t em_addr)
{
    uint8_t res;
    /// opcode
    em_rd(&res, em_addr, 1);
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint16_t em_read_16(uint16_t em_addr)
{
    uint16_t res;
    /// opcode
    em_rd(&res, em_addr, 2);
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint32_t em_read_32(uint16_t em_addr)
{
    uint32_t res;
    /// opcode
    em_rd(&res, em_addr, 4);
