 ...
 ****************************************************************************************
 */
__BLE_INLINE int8_t llm_util_ch_assess_get_upper_limit(void)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE int8_t llm_util_ch_assess_get_lower_limit(void)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE int8_t llm_util_ch_assess_get_reass_cnt(void)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE int8_t llm_util_ch_assess_get_rssi_noise(void)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE int8_t llm_util_ch_assess_get_assess_timer(void)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE bool llm_util_check_adv_report_list(struct bd_addr *adv_bd_addr, uint8_t adv_type)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE void llm_util_set_param_scan_dft(void)
{
...
*****************************************************************************************
*/
__BLE_INLINE void llm_util_aa_gen(uint8_t *acc_addr)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE void llm_util_gen_pattern(uint8_t pattern_type, uint8_t payload_len ,
        uint8_t *payload)
{
    uint8_t pattern = 0;
    // get the pattern
...
__BLE_INLINE void llm_util_set_param_adv_dft(void)
{
    // Allocate a structure containing scan parameters
 ...
 ****************************************************************************************
 */
__BLE_INLINE void llm_util_chk_tst_mode(void)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint8_t llm_util_get_adv_type(void)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint16_t llm_util_dle_get_tx_max_size(void)
{
