 ...
 ****************************************************************************************
 */
__BLE_INLINE uint8_t llc_util_get_active_conhdl(void)
{
    uint8_t idx;
 ...
 ****************************************************************************************
 */
__BLE_INLINE bool llc_util_event_enabled(uint8_t meta_event)
{
    uint8_t idx;
    uint8_t cpt_active=0;
    ke_task_id_t llc_free;
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint16_t llc_util_rxl2clen_getf(uint8_t *data)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE void llc_util_ivm_set(uint16_t conhdl, uint8_t const *ivm)
{
    for (int i = 0; i < 2; i++)
    {
 ...
 ****************************************************************************************
 */
__BLE_INLINE void llc_util_ivs_set(uint16_t conhdl, uint8_t const *ivs)
{
    for (int i = 0; i < 2; i++)
    {
 ...
 ****************************************************************************************
 */
__BLE_INLINE bool llc_util_disc_reason_ok(uint8_t reason)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE void llc_util_set_operation_ptr(uint16_t conhdl, uint8_t op_type, void* op)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE void* llc_util_get_operation_ptr(uint16_t conhdl, uint8_t op_type)
{
    ASSERT_ERR(op_type < LLC_OP_MAX);
    struct llc_env_tag *llc_env_ptr = llc_env[conhdl];
 ...
 ****************************************************************************************
 */
__BLE_INLINE struct ea_elt_tag * llc_util_get_element_ptr(uint16_t conhdl)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE bool llc_state_chk(ke_state_t state, uint8_t procedure)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE void llc_state_update(ke_task_id_t task, ke_state_t *state, uint8_t procedure, bool enable)
{
