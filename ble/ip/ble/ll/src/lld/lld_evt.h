 ...
 ****************************************************************************************
 */
__BLE_INLINE uint8_t lld_evt_sca_get(void)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint32_t lld_evt_time_get(void)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE bool lld_evt_time_cmp(uint32_t time1,
                               uint32_t time2)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE bool lld_evt_time_past(uint32_t time)
{
...
void lld_evt_schedule_next_instant(struct ea_elt_tag *elt);
