 ...
 */
static int
hci_dbg_audio_configure_cmd_handler(ke_msg_id_t const msgid, struct hci_dbg_audio_configure_audio_cmd const *param,
                         ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // structure type for the complete command event
    struct hci_basic_cmd_cmp_evt *event = KE_MSG_ALLOC(HCI_CMD_CMP_EVENT , 0, src_id, hci_basic_cmd_cmp_evt);
 ...
 */
static int
hci_dbg_audio_set_pointer_cmd_handler(ke_msg_id_t const msgid, struct hci_dbg_audio_set_pointer_cmd const *param,
                         ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // structure type for the complete command event
    struct hci_basic_cmd_cmp_evt *event = KE_MSG_ALLOC(HCI_CMD_CMP_EVENT , 0, src_id, hci_basic_cmd_cmp_evt);
 ...
 */
static int
hci_dbg_audio_set_mode_cmd_handler(ke_msg_id_t const msgid, struct hci_audio_set_mode_cmd const *param,
                         ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // structure type for the complete command event
    struct hci_basic_cmd_cmp_evt *event = KE_MSG_ALLOC(HCI_CMD_CMP_EVENT , 0, src_id, hci_basic_cmd_cmp_evt);
 ...
 */
static int
hci_dbg_audio_reset_cmd_handler(ke_msg_id_t const msgid, struct hci_dbg_audio_reset_cmd const *param,
                         ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // structure type for the complete command event
    struct hci_basic_cmd_cmp_evt *event = KE_MSG_ALLOC(HCI_CMD_CMP_EVENT , 0, src_id, hci_basic_cmd_cmp_evt);
 ...
 */
static int
hci_dbg_audio_allocate_cmd_handler(ke_msg_id_t const msgid, struct hci_dbg_audio_allocate_cmd const *param,
                         ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // structure type for the complete command event
    struct hci_basic_cmd_cmp_evt *event = KE_MSG_ALLOC(HCI_CMD_CMP_EVENT , 0, src_id, hci_basic_cmd_cmp_evt);
    ...
    event->status = audio_allocate(param->conhdl,param->mode,&voice_channel);
 ...
 */
static int
hci_dbg_audio_get_vx_ch_cmd_handler(ke_msg_id_t const msgid, struct hci_dbg_audio_get_vx_ch_cmd const *param,
                         ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    // structure type for the complete command event
    struct hci_basic_cmd_cmp_evt *event = KE_MSG_ALLOC(HCI_CMD_CMP_EVENT , 0, src_id, hci_basic_cmd_cmp_evt);
    ...
    uint8_t voice_channel;
    event->status = audio_get_voice_channel(param->conhdl, &voice_channel);
    if(event->status != CO_ERROR_UNKNOWN_CONNECTION_ID)
    {
        event->status = voice_channel;
    }
...
static const struct ke_msg_handler dbg_hci_command_handler_tab[] =
{
        ...
        #if(BLE_AUDIO)
        {HCI_DBG_AUDIO_CONFIGURE_CMD_OPCODE, (ke_msg_func_t)hci_dbg_audio_configure_cmd_handler},
        {HCI_DBG_AUDIO_SET_MODE_CMD_OPCODE, (ke_msg_func_t)hci_dbg_audio_set_mode_cmd_handler},
        {HCI_DBG_AUDIO_RESET_CMD_OPCODE, (ke_msg_func_t)hci_dbg_audio_reset_cmd_handler},
        {HCI_DBG_AUDIO_SET_POINTER_CMD_OPCODE, (ke_msg_func_t)hci_dbg_audio_set_pointer_cmd_handler},
        {HCI_DBG_AUDIO_ALLOCATE_CMD_OPCODE, (ke_msg_func_t)hci_dbg_audio_allocate_cmd_handler},
        {HCI_DBG_AUDIO_GET_VX_CH_CMD_OPCODE, (ke_msg_func_t)hci_dbg_audio_get_vx_ch_cmd_handler},
        #endif // #if (BLE_AUDIO)
        #endif // #if (BLE_PERIPHERAL || BLE_CENTRAL)
        #endif
};
