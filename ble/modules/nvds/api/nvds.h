...
uint8_t app_nvds_init(uint8_t *base, uint32_t len);
uint8_t app_nvds_del(uint8_t tag);
uint8_t app_nvds_put(uint8_t tag, uint8_t length, uint8_t *buf);
uint8_t app_nvds_get(uint8_t tag, uint8_t * lengthPtr, uint8_t *buf);
