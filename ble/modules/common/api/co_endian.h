 ...
 ****************************************************************************************
 */
__BLE_INLINE uint32_t co_bswap32(uint32_t val32)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint16_t co_bswap16(uint16_t val16)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint32_t co_htonl(uint32_t hostlong)
{
    #if (!CPU_LE)
        return hostlong;
    #else
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint16_t co_htons(uint16_t hostshort)
{
    #if (!CPU_LE)
        return hostshort;
    #else
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint32_t co_ntohl(uint32_t netlong)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint16_t co_ntohs(uint16_t netshort)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint32_t co_htobl(uint32_t hostlong)
{
    #if (CPU_LE)
        return hostlong;
    #else
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint16_t co_htobs(uint16_t hostshort)
{
    #if (CPU_LE)
        return hostshort;
    #else
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint32_t co_btohl(uint32_t btlong)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint16_t co_btohs(uint16_t btshort)
{
