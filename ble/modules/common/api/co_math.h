...
#include "compiler.h"      // for __BLE_INLINE
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint32_t co_clz(uint32_t val)
{
    #if defined(__arm__)
 ...
 ****************************************************************************************
 */
__BLE_INLINE void co_random_init(uint32_t seed)
{
    srand(seed);
}
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint8_t co_rand_byte(void)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint16_t co_rand_hword(void)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint32_t co_rand_word(void)
{
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint32_t co_min(uint32_t a, uint32_t b)
{
    return a < b ? a : b;
}
 ...
 ****************************************************************************************
 */
__BLE_INLINE uint32_t co_max(uint32_t a, uint32_t b)
{
    return a > b ? a : b;
}
 ...
 ****************************************************************************************
 */
__BLE_INLINE int co_abs(int val)
{
