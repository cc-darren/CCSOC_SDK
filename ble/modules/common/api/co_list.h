 ...
 ****************************************************************************************
 */
__BLE_INLINE bool co_list_is_empty(const struct co_list *const list)
{
    bool listempty;
 ...
 ****************************************************************************************
 */
__BLE_INLINE struct co_list_hdr *co_list_pick(const struct co_list *const list)
{
    return(list->first);
}
 ...
 ****************************************************************************************
 */
__BLE_INLINE struct co_list_hdr *co_list_next(const struct co_list_hdr *const list_hdr)
{
