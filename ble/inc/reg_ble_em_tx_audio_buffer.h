...
__BLE_INLINE uint16_t ble_txaudiobuf_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 31);
...
__BLE_INLINE void ble_txaudiobuf_setf(int elt_idx, int reg_idx, uint16_t txaudiobuf)
{
    ASSERT_ERR(reg_idx <= 31);
