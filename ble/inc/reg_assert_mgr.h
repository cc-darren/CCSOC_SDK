...
__BLE_INLINE uint32_t asrt_assert_get(void)
{
    return REG_PL_RD(ASRT_ASSERT_ADDR);
}

__BLE_INLINE void asrt_assert_set(uint32_t value)
{
...
__BLE_INLINE void asrt_assert_pack(uint8_t txtsize, uint8_t params, uint8_t warn, uint8_t trigg)
{
...
__BLE_INLINE void asrt_assert_unpack(uint8_t* txtsize, uint8_t* params, uint8_t* warn, uint8_t* trigg)
{
...
__BLE_INLINE uint32_t asrt_param_get(void)
{
    return REG_PL_RD(ASRT_PARAM_ADDR);
}

__BLE_INLINE void asrt_param_set(uint32_t value)
{
...
__BLE_INLINE void asrt_param_pack(uint16_t param2, uint16_t param1)
{
...
__BLE_INLINE void asrt_param_unpack(uint16_t* param2, uint16_t* param1)
{
...
__BLE_INLINE uint16_t asrt_param_2_getf(void)
{
    uint32_t localVal = REG_PL_RD(ASRT_PARAM_ADDR);
    return ((localVal & ((uint32_t)0xFFFF0000)) >> 16);
}

__BLE_INLINE void asrt_param_2_setf(uint16_t param2)
{
    ASSERT_ERR((((uint32_t)param2 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_PL_WR(ASRT_PARAM_ADDR, (REG_PL_RD(ASRT_PARAM_ADDR) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)param2 << 16));
}

__BLE_INLINE uint16_t asrt_param_1_getf(void)
{
    uint32_t localVal = REG_PL_RD(ASRT_PARAM_ADDR);
    return ((localVal & ((uint32_t)0x0000FFFF)) >> 0);
}

__BLE_INLINE void asrt_param_1_setf(uint16_t param1)
{
    ASSERT_ERR((((uint32_t)param1 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
...
__BLE_INLINE uint32_t asrt_line_get(void)
{
    return REG_PL_RD(ASRT_LINE_ADDR);
}

__BLE_INLINE void asrt_line_set(uint32_t value)
{
...
__BLE_INLINE uint32_t asrt_line_getf(void)
{
...
__BLE_INLINE void asrt_line_setf(uint32_t line)
{
...
__BLE_INLINE uint32_t asrt_text_get(void)
{
    return REG_PL_RD(ASRT_TEXT_ADDR);
}

__BLE_INLINE void asrt_text_set(uint32_t value)
{
...
__BLE_INLINE uint32_t asrt_addr_getf(void)
{
...
__BLE_INLINE void asrt_addr_setf(uint32_t addr)
{
