 ...
 * </pre>
 */
#define BLE_CNTL_ADDR   (0x40006000 + EM_BLE_CS_OFFSET)
#define BLE_CNTL_INDEX  0x00000000
#define BLE_CNTL_RESET  0x00000000

__BLE_INLINE uint16_t ble_cntl_get(int elt_idx)
{
    return EM_BLE_RD(BLE_CNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_cntl_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE void ble_cntl_pack(int elt_idx, uint8_t pti, uint8_t txbsyen, uint8_t rxbsyen, uint8_t dnabort, uint8_t format)
{
...
__BLE_INLINE void ble_cntl_unpack(int elt_idx, uint8_t* pti, uint8_t* txbsyen, uint8_t* rxbsyen, uint8_t* dnabort, uint8_t* format)
{
...
__BLE_INLINE uint8_t ble_pti_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_CNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000F000)) >> 12);
}

__BLE_INLINE void ble_pti_setf(int elt_idx, uint8_t pti)
{
    ASSERT_ERR((((uint16_t)pti << 12) & ~((uint16_t)0x0000F000)) == 0);
...
__BLE_INLINE uint8_t ble_txbsy_en_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_CNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000400)) >> 10);
}

__BLE_INLINE void ble_txbsy_en_setf(int elt_idx, uint8_t txbsyen)
{
    ASSERT_ERR((((uint16_t)txbsyen << 10) & ~((uint16_t)0x00000400)) == 0);
...
__BLE_INLINE uint8_t ble_rxbsy_en_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_CNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000200)) >> 9);
}

__BLE_INLINE void ble_rxbsy_en_setf(int elt_idx, uint8_t rxbsyen)
{
    ASSERT_ERR((((uint16_t)rxbsyen << 9) & ~((uint16_t)0x00000200)) == 0);
...
__BLE_INLINE uint8_t ble_dnabort_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_CNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000100)) >> 8);
}

__BLE_INLINE void ble_dnabort_setf(int elt_idx, uint8_t dnabort)
{
    ASSERT_ERR((((uint16_t)dnabort << 8) & ~((uint16_t)0x00000100)) == 0);
...
__BLE_INLINE uint8_t ble_format_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_CNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000001F)) >> 0);
}

__BLE_INLINE void ble_format_setf(int elt_idx, uint8_t format)
{
    ASSERT_ERR((((uint16_t)format << 0) & ~((uint16_t)0x0000001F)) == 0);
 ...
 * </pre>
 */
#define BLE_FCNTOFFSET_ADDR   (0x40006002 + EM_BLE_CS_OFFSET)
#define BLE_FCNTOFFSET_INDEX  0x00000001
#define BLE_FCNTOFFSET_RESET  0x00000000

__BLE_INLINE uint16_t ble_fcntoffset_get(int elt_idx)
{
    return EM_BLE_RD(BLE_FCNTOFFSET_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_fcntoffset_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_fcntoffset_getf(int elt_idx)
{
...
__BLE_INLINE void ble_fcntoffset_setf(int elt_idx, uint16_t fcntoffset)
{
 ...
 * </pre>
 */
#define BLE_LINK_ADDR   (0x40006004 + EM_BLE_CS_OFFSET)
#define BLE_LINK_INDEX  0x00000002
#define BLE_LINK_RESET  0x00000000

__BLE_INLINE uint16_t ble_link_get(int elt_idx)
{
    return EM_BLE_RD(BLE_LINK_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_link_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE void ble_link_pack(int elt_idx, uint8_t rxthr, uint8_t nullrxllidflt, uint8_t cryptmode, uint8_t txcrypten, uint8_t rxcrypten, uint8_t linklbl)
{
    ...
    EM_BLE_WR(BLE_LINK_ADDR + elt_idx * REG_BLE_EM_CS_SIZE,  ((uint16_t)rxthr << 12) | ((uint16_t)nullrxllidflt << 11) | ((uint16_t)cryptmode << 10) | ((uint16_t)txcrypten << 9) | ((uint16_t)rxcrypten << 8) | ((uint16_t)linklbl << 0));
}

__BLE_INLINE void ble_link_unpack(int elt_idx, uint8_t* rxthr, uint8_t* nullrxllidflt, uint8_t* cryptmode, uint8_t* txcrypten, uint8_t* rxcrypten, uint8_t* linklbl)
{
...
__BLE_INLINE uint8_t ble_rxthr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_LINK_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000F000)) >> 12);
}

__BLE_INLINE void ble_rxthr_setf(int elt_idx, uint8_t rxthr)
{
    ASSERT_ERR((((uint16_t)rxthr << 12) & ~((uint16_t)0x0000F000)) == 0);
...
__BLE_INLINE uint8_t ble_nullrxllidflt_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_LINK_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000800)) >> 11);
}

__BLE_INLINE void ble_nullrxllidflt_setf(int elt_idx, uint8_t nullrxllidflt)
{
    ASSERT_ERR((((uint16_t)nullrxllidflt << 11) & ~((uint16_t)0x00000800)) == 0);
...
__BLE_INLINE uint8_t ble_crypt_mode_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_LINK_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000400)) >> 10);
}

__BLE_INLINE void ble_crypt_mode_setf(int elt_idx, uint8_t cryptmode)
{
    ASSERT_ERR((((uint16_t)cryptmode << 10) & ~((uint16_t)0x00000400)) == 0);
...
__BLE_INLINE uint8_t ble_txcrypt_en_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_LINK_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000200)) >> 9);
}

__BLE_INLINE void ble_txcrypt_en_setf(int elt_idx, uint8_t txcrypten)
{
    ASSERT_ERR((((uint16_t)txcrypten << 9) & ~((uint16_t)0x00000200)) == 0);
...
__BLE_INLINE uint8_t ble_rxcrypt_en_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_LINK_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000100)) >> 8);
}

__BLE_INLINE void ble_rxcrypt_en_setf(int elt_idx, uint8_t rxcrypten)
{
    ASSERT_ERR((((uint16_t)rxcrypten << 8) & ~((uint16_t)0x00000100)) == 0);
...
__BLE_INLINE uint8_t ble_linklbl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_LINK_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000001F)) >> 0);
}

__BLE_INLINE void ble_linklbl_setf(int elt_idx, uint8_t linklbl)
{
    ASSERT_ERR((((uint16_t)linklbl << 0) & ~((uint16_t)0x0000001F)) == 0);
 ...
 * </pre>
 */
#define BLE_SYNCWL_ADDR   (0x40006006 + EM_BLE_CS_OFFSET)
#define BLE_SYNCWL_INDEX  0x00000003
#define BLE_SYNCWL_RESET  0x00000000

__BLE_INLINE uint16_t ble_syncwl_get(int elt_idx)
{
    return EM_BLE_RD(BLE_SYNCWL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_syncwl_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_syncwordl_getf(int elt_idx)
{
...
__BLE_INLINE void ble_syncwordl_setf(int elt_idx, uint16_t syncwordl)
{
 ...
 * </pre>
 */
#define BLE_SYNCWH_ADDR   (0x40006008 + EM_BLE_CS_OFFSET)
#define BLE_SYNCWH_INDEX  0x00000004
#define BLE_SYNCWH_RESET  0x00000000

__BLE_INLINE uint16_t ble_syncwh_get(int elt_idx)
{
    return EM_BLE_RD(BLE_SYNCWH_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_syncwh_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_syncwordh_getf(int elt_idx)
{
...
__BLE_INLINE void ble_syncwordh_setf(int elt_idx, uint16_t syncwordh)
{
 ...
 * </pre>
 */
#define BLE_CRCINIT0_ADDR   (0x4000600A + EM_BLE_CS_OFFSET)
#define BLE_CRCINIT0_INDEX  0x00000005
#define BLE_CRCINIT0_RESET  0x00000000

__BLE_INLINE uint16_t ble_crcinit0_get(int elt_idx)
{
    return EM_BLE_RD(BLE_CRCINIT0_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_crcinit0_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_crcinit0_getf(int elt_idx)
{
...
__BLE_INLINE void ble_crcinit0_setf(int elt_idx, uint16_t crcinit0)
{
 ...
 * </pre>
 */
#define BLE_CRCINIT1_ADDR   (0x4000600C + EM_BLE_CS_OFFSET)
#define BLE_CRCINIT1_INDEX  0x00000006
#define BLE_CRCINIT1_RESET  0x00000000

__BLE_INLINE uint16_t ble_crcinit1_get(int elt_idx)
{
    return EM_BLE_RD(BLE_CRCINIT1_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_crcinit1_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint8_t ble_crcinit1_getf(int elt_idx)
{
...
__BLE_INLINE void ble_crcinit1_setf(int elt_idx, uint8_t crcinit1)
{
 ...
 * </pre>
 */
#define BLE_FILTPOL_RALCNTL_ADDR   (0x4000600E + EM_BLE_CS_OFFSET)
#define BLE_FILTPOL_RALCNTL_INDEX  0x00000007
#define BLE_FILTPOL_RALCNTL_RESET  0x00000000

__BLE_INLINE uint16_t ble_filtpol_ralcntl_get(int elt_idx)
{
    return EM_BLE_RD(BLE_FILTPOL_RALCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_filtpol_ralcntl_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE void ble_filtpol_ralcntl_pack(int elt_idx, uint8_t filterpolicy, uint8_t localrpasel, uint8_t ralmode, uint8_t ralen)
{
...
__BLE_INLINE void ble_filtpol_ralcntl_unpack(int elt_idx, uint8_t* filterpolicy, uint8_t* localrpasel, uint8_t* ralmode, uint8_t* ralen)
{
...
__BLE_INLINE uint8_t ble_filter_policy_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_FILTPOL_RALCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000FF00)) >> 8);
}

__BLE_INLINE void ble_filter_policy_setf(int elt_idx, uint8_t filterpolicy)
{
    ASSERT_ERR((((uint16_t)filterpolicy << 8) & ~((uint16_t)0x0000FF00)) == 0);
...
__BLE_INLINE uint8_t ble_local_rpa_sel_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_FILTPOL_RALCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000004)) >> 2);
}

__BLE_INLINE void ble_local_rpa_sel_setf(int elt_idx, uint8_t localrpasel)
{
    ASSERT_ERR((((uint16_t)localrpasel << 2) & ~((uint16_t)0x00000004)) == 0);
...
__BLE_INLINE uint8_t ble_ral_mode_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_FILTPOL_RALCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000002)) >> 1);
}

__BLE_INLINE void ble_ral_mode_setf(int elt_idx, uint8_t ralmode)
{
    ASSERT_ERR((((uint16_t)ralmode << 1) & ~((uint16_t)0x00000002)) == 0);
...
__BLE_INLINE uint8_t ble_ral_en_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_FILTPOL_RALCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000001)) >> 0);
}

__BLE_INLINE void ble_ral_en_setf(int elt_idx, uint8_t ralen)
{
    ASSERT_ERR((((uint16_t)ralen << 0) & ~((uint16_t)0x00000001)) == 0);
 ...
 * </pre>
 */
#define BLE_HOPCNTL_ADDR   (0x40006010 + EM_BLE_CS_OFFSET)
#define BLE_HOPCNTL_INDEX  0x00000008
#define BLE_HOPCNTL_RESET  0x00000000

__BLE_INLINE uint16_t ble_hopcntl_get(int elt_idx)
{
    return EM_BLE_RD(BLE_HOPCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_hopcntl_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE void ble_hopcntl_pack(int elt_idx, uint8_t fhen, uint8_t hopint, uint8_t chidx)
{
...
__BLE_INLINE void ble_hopcntl_unpack(int elt_idx, uint8_t* fhen, uint8_t* hopint, uint8_t* chidx)
{
...
__BLE_INLINE uint8_t ble_fh_en_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_HOPCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__BLE_INLINE void ble_fh_en_setf(int elt_idx, uint8_t fhen)
{
    ASSERT_ERR((((uint16_t)fhen << 15) & ~((uint16_t)0x00008000)) == 0);
...
__BLE_INLINE uint8_t ble_hop_int_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_HOPCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00001F00)) >> 8);
}

__BLE_INLINE void ble_hop_int_setf(int elt_idx, uint8_t hopint)
{
    ASSERT_ERR((((uint16_t)hopint << 8) & ~((uint16_t)0x00001F00)) == 0);
...
__BLE_INLINE uint8_t ble_ch_idx_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_HOPCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000003F)) >> 0);
}

__BLE_INLINE void ble_ch_idx_setf(int elt_idx, uint8_t chidx)
{
    ASSERT_ERR((((uint16_t)chidx << 0) & ~((uint16_t)0x0000003F)) == 0);
 ...
 * </pre>
 */
#define BLE_TXRXCNTL_ADDR   (0x40006012 + EM_BLE_CS_OFFSET)
#define BLE_TXRXCNTL_INDEX  0x00000009
#define BLE_TXRXCNTL_RESET  0x00000000

__BLE_INLINE uint16_t ble_txrxcntl_get(int elt_idx)
{
    return EM_BLE_RD(BLE_TXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_txrxcntl_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE void ble_txrxcntl_pack(int elt_idx, uint8_t rxbufffull, uint8_t lastempty, uint8_t sn, uint8_t nesn, uint8_t txpwr)
{
...
__BLE_INLINE void ble_txrxcntl_unpack(int elt_idx, uint8_t* rxbufffull, uint8_t* lastempty, uint8_t* sn, uint8_t* nesn, uint8_t* rxbfmicerr, uint8_t* txpwr)
{
...
__BLE_INLINE uint8_t ble_rxbuff_full_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_TXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__BLE_INLINE void ble_rxbuff_full_setf(int elt_idx, uint8_t rxbufffull)
{
    ASSERT_ERR((((uint16_t)rxbufffull << 15) & ~((uint16_t)0x00008000)) == 0);
...
__BLE_INLINE uint8_t ble_lastempty_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_TXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00004000)) >> 14);
}

__BLE_INLINE void ble_lastempty_setf(int elt_idx, uint8_t lastempty)
{
    ASSERT_ERR((((uint16_t)lastempty << 14) & ~((uint16_t)0x00004000)) == 0);
...
__BLE_INLINE uint8_t ble_sn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_TXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00002000)) >> 13);
}

__BLE_INLINE void ble_sn_setf(int elt_idx, uint8_t sn)
{
    ASSERT_ERR((((uint16_t)sn << 13) & ~((uint16_t)0x00002000)) == 0);
...
__BLE_INLINE uint8_t ble_nesn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_TXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00001000)) >> 12);
}

__BLE_INLINE void ble_nesn_setf(int elt_idx, uint8_t nesn)
{
    ASSERT_ERR((((uint16_t)nesn << 12) & ~((uint16_t)0x00001000)) == 0);
...
__BLE_INLINE uint8_t ble_rxbfmicerr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_TXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000800)) >> 11);
}

__BLE_INLINE uint8_t ble_txpwr_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_TXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x000000FF)) >> 0);
}

__BLE_INLINE void ble_txpwr_setf(int elt_idx, uint8_t txpwr)
{
    ASSERT_ERR((((uint16_t)txpwr << 0) & ~((uint16_t)0x000000FF)) == 0);
 ...
 * </pre>
 */
#define BLE_RXWINCNTL_ADDR   (0x40006014 + EM_BLE_CS_OFFSET)
#define BLE_RXWINCNTL_INDEX  0x0000000A
#define BLE_RXWINCNTL_RESET  0x00000000

__BLE_INLINE uint16_t ble_rxwincntl_get(int elt_idx)
{
    return EM_BLE_RD(BLE_RXWINCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_rxwincntl_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE void ble_rxwincntl_pack(int elt_idx, uint8_t rxwide, uint16_t rxwinsz)
{
...
__BLE_INLINE void ble_rxwincntl_unpack(int elt_idx, uint8_t* rxwide, uint16_t* rxwinsz)
{
...
__BLE_INLINE uint8_t ble_rxwide_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_RXWINCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__BLE_INLINE void ble_rxwide_setf(int elt_idx, uint8_t rxwide)
{
    ASSERT_ERR((((uint16_t)rxwide << 15) & ~((uint16_t)0x00008000)) == 0);
...
__BLE_INLINE uint16_t ble_rxwinsz_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_RXWINCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00003FFF)) >> 0);
}

__BLE_INLINE void ble_rxwinsz_setf(int elt_idx, uint16_t rxwinsz)
{
    ASSERT_ERR((((uint16_t)rxwinsz << 0) & ~((uint16_t)0x00003FFF)) == 0);
 ...
 * </pre>
 */
#define BLE_TXDESCPTR_ADDR   (0x40006016 + EM_BLE_CS_OFFSET)
#define BLE_TXDESCPTR_INDEX  0x0000000B
#define BLE_TXDESCPTR_RESET  0x00000000

__BLE_INLINE uint16_t ble_txdescptr_get(int elt_idx)
{
    return EM_BLE_RD(BLE_TXDESCPTR_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_txdescptr_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_txdescptr_getf(int elt_idx)
{
...
__BLE_INLINE void ble_txdescptr_setf(int elt_idx, uint16_t txdescptr)
{
 ...
 * </pre>
 */
#define BLE_WINOFFSET_ADDR   (0x40006018 + EM_BLE_CS_OFFSET)
#define BLE_WINOFFSET_INDEX  0x0000000C
#define BLE_WINOFFSET_RESET  0x00000000

__BLE_INLINE uint16_t ble_winoffset_get(int elt_idx)
{
    return EM_BLE_RD(BLE_WINOFFSET_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_winoffset_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_winoffset_getf(int elt_idx)
{
...
__BLE_INLINE void ble_winoffset_setf(int elt_idx, uint16_t winoffset)
{
 ...
 * </pre>
 */
#define BLE_MINEVTIME_ADDR   (0x40006018 + EM_BLE_CS_OFFSET)
#define BLE_MINEVTIME_INDEX  0x0000000C
#define BLE_MINEVTIME_RESET  0x00000000

__BLE_INLINE uint16_t ble_minevtime_get(int elt_idx)
{
    return EM_BLE_RD(BLE_MINEVTIME_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_minevtime_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_minevtime_getf(int elt_idx)
{
...
__BLE_INLINE void ble_minevtime_setf(int elt_idx, uint16_t minevtime)
{
 ...
 * </pre>
 */
#define BLE_MAXEVTIME_ADDR   (0x4000601A + EM_BLE_CS_OFFSET)
#define BLE_MAXEVTIME_INDEX  0x0000000D
#define BLE_MAXEVTIME_RESET  0x00000000

__BLE_INLINE uint16_t ble_maxevtime_get(int elt_idx)
{
    return EM_BLE_RD(BLE_MAXEVTIME_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_maxevtime_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_maxevtime_getf(int elt_idx)
{
...
__BLE_INLINE void ble_maxevtime_setf(int elt_idx, uint16_t maxevtime)
{
 ...
 * </pre>
 */
#define BLE_CONNINTERVAL_ADDR   (0x4000601C + EM_BLE_CS_OFFSET)
#define BLE_CONNINTERVAL_INDEX  0x0000000E
#define BLE_CONNINTERVAL_RESET  0x00000000

__BLE_INLINE uint16_t ble_conninterval_get(int elt_idx)
{
    return EM_BLE_RD(BLE_CONNINTERVAL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_conninterval_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_conninterval_getf(int elt_idx)
{
...
__BLE_INLINE void ble_conninterval_setf(int elt_idx, uint16_t conninterval)
{
 ...
 * </pre>
 */
#define BLE_CHMAP0_ADDR   (0x4000601C + EM_BLE_CS_OFFSET)
#define BLE_CHMAP0_INDEX  0x0000000E
#define BLE_CHMAP0_RESET  0x0000FFFF

__BLE_INLINE uint16_t ble_chmap0_get(int elt_idx)
{
    return EM_BLE_RD(BLE_CHMAP0_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_chmap0_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_llchmap0_getf(int elt_idx)
{
...
__BLE_INLINE void ble_llchmap0_setf(int elt_idx, uint16_t llchmap0)
{
 ...
 * </pre>
 */
#define BLE_CHMAP1_ADDR   (0x4000601E + EM_BLE_CS_OFFSET)
#define BLE_CHMAP1_INDEX  0x0000000F
#define BLE_CHMAP1_RESET  0x0000FFFF

__BLE_INLINE uint16_t ble_chmap1_get(int elt_idx)
{
    return EM_BLE_RD(BLE_CHMAP1_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_chmap1_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_llchmap1_getf(int elt_idx)
{
...
__BLE_INLINE void ble_llchmap1_setf(int elt_idx, uint16_t llchmap1)
{
 ...
 * </pre>
 */
#define BLE_CHMAP2_ADDR   (0x40006020 + EM_BLE_CS_OFFSET)
#define BLE_CHMAP2_INDEX  0x00000010
#define BLE_CHMAP2_RESET  0x0000251F

__BLE_INLINE uint16_t ble_chmap2_get(int elt_idx)
{
    return EM_BLE_RD(BLE_CHMAP2_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_chmap2_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE void ble_chmap2_pack(int elt_idx, uint8_t nbchgood, uint8_t llchmap3)
{
...
__BLE_INLINE void ble_chmap2_unpack(int elt_idx, uint8_t* nbchgood, uint8_t* llchmap3)
{
...
__BLE_INLINE uint8_t ble_nbchgood_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_CHMAP2_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00003F00)) >> 8);
}

__BLE_INLINE void ble_nbchgood_setf(int elt_idx, uint8_t nbchgood)
{
    ASSERT_ERR((((uint16_t)nbchgood << 8) & ~((uint16_t)0x00003F00)) == 0);
...
__BLE_INLINE uint8_t ble_llchmap3_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_CHMAP2_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000001F)) >> 0);
}

__BLE_INLINE void ble_llchmap3_setf(int elt_idx, uint8_t llchmap3)
{
    ASSERT_ERR((((uint16_t)llchmap3 << 0) & ~((uint16_t)0x0000001F)) == 0);
 ...
 * </pre>
 */
#define BLE_RXMAXBUF_ADDR   (0x40006022 + EM_BLE_CS_OFFSET)
#define BLE_RXMAXBUF_INDEX  0x00000011
#define BLE_RXMAXBUF_RESET  0x00000000

__BLE_INLINE uint16_t ble_rxmaxbuf_get(int elt_idx)
{
    return EM_BLE_RD(BLE_RXMAXBUF_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_rxmaxbuf_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint8_t ble_rxmaxbuf_getf(int elt_idx)
{
...
__BLE_INLINE void ble_rxmaxbuf_setf(int elt_idx, uint8_t rxmaxbuf)
{
 ...
 * </pre>
 */
#define BLE_RXMAXTIME_ADDR   (0x40006024 + EM_BLE_CS_OFFSET)
#define BLE_RXMAXTIME_INDEX  0x00000012
#define BLE_RXMAXTIME_RESET  0x00000000

__BLE_INLINE uint16_t ble_rxmaxtime_get(int elt_idx)
{
    return EM_BLE_RD(BLE_RXMAXTIME_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_rxmaxtime_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_rxmaxtime_getf(int elt_idx)
{
...
__BLE_INLINE void ble_rxmaxtime_setf(int elt_idx, uint16_t rxmaxtime)
{
 ...
 * </pre>
 */
#define BLE_SK_ADDR   (0x40006026 + EM_BLE_CS_OFFSET)
#define BLE_SK_INDEX  0x00000013
#define BLE_SK_RESET  0x00000000
#define BLE_SK_COUNT  8

__BLE_INLINE uint16_t ble_sk_get(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 7);
    return EM_BLE_RD(BLE_SK_ADDR + elt_idx * REG_BLE_EM_CS_SIZE + reg_idx * 2);
}

__BLE_INLINE void ble_sk_set(int elt_idx, int reg_idx, uint16_t value)
{
    ASSERT_ERR(reg_idx <= 7);
...
__BLE_INLINE uint16_t ble_sk_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 7);
...
__BLE_INLINE void ble_sk_setf(int elt_idx, int reg_idx, uint16_t sk)
{
    ASSERT_ERR(reg_idx <= 7);
...
__BLE_INLINE uint16_t ble_adv_bd_addr_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 2);
...
__BLE_INLINE void ble_adv_bd_addr_setf(int elt_idx, int reg_idx, uint16_t advbdaddr)
{
    ASSERT_ERR(reg_idx <= 2);
 ...
 * </pre>
 */
#define BLE_PEER_RALPTR_ADDR   (0x40006026 + EM_BLE_CS_OFFSET)
#define BLE_PEER_RALPTR_INDEX  0x00000013
#define BLE_PEER_RALPTR_RESET  0x00000000

__BLE_INLINE uint16_t ble_peer_ralptr_get(int elt_idx)
{
    return EM_BLE_RD(BLE_PEER_RALPTR_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_peer_ralptr_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_peer_ralptr_getf(int elt_idx)
{
...
__BLE_INLINE void ble_peer_ralptr_setf(int elt_idx, uint16_t peerralptr)
{
 ...
 * </pre>
 */
#define BLE_ADV_BD_ADDR_TYPE_ADDR   (0x4000602C + EM_BLE_CS_OFFSET)
#define BLE_ADV_BD_ADDR_TYPE_INDEX  0x00000016
#define BLE_ADV_BD_ADDR_TYPE_RESET  0x00000000

__BLE_INLINE uint16_t ble_adv_bd_addr_type_get(int elt_idx)
{
    return EM_BLE_RD(BLE_ADV_BD_ADDR_TYPE_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_adv_bd_addr_type_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint8_t ble_adv_bd_addr_type_getf(int elt_idx)
{
...
__BLE_INLINE void ble_adv_bd_addr_type_setf(int elt_idx, uint8_t advbdaddrtype)
{
 ...
 * </pre>
 */
#define BLE_IV_ADDR   (0x40006036 + EM_BLE_CS_OFFSET)
#define BLE_IV_INDEX  0x0000001B
#define BLE_IV_RESET  0x00000000
#define BLE_IV_COUNT  4

__BLE_INLINE uint16_t ble_iv_get(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 3);
    return EM_BLE_RD(BLE_IV_ADDR + elt_idx * REG_BLE_EM_CS_SIZE + reg_idx * 2);
}

__BLE_INLINE void ble_iv_set(int elt_idx, int reg_idx, uint16_t value)
{
    ASSERT_ERR(reg_idx <= 3);
...
__BLE_INLINE uint16_t ble_iv_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 3);
...
__BLE_INLINE void ble_iv_setf(int elt_idx, int reg_idx, uint16_t iv)
{
    ASSERT_ERR(reg_idx <= 3);
 ...
 * </pre>
 */
#define BLE_TXWINOFFSET_ADDR   (0x4000603E + EM_BLE_CS_OFFSET)
#define BLE_TXWINOFFSET_INDEX  0x0000001F
#define BLE_TXWINOFFSET_RESET  0x00000000

__BLE_INLINE uint16_t ble_txwinoffset_get(int elt_idx)
{
    return EM_BLE_RD(BLE_TXWINOFFSET_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_txwinoffset_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_txwinoffset_getf(int elt_idx)
{
...
__BLE_INLINE void ble_txwinoffset_setf(int elt_idx, uint16_t txwinoffset)
{
 ...
 * </pre>
 */
#define BLE_TXCCMPKTCNT0_ADDR   (0x4000603E + EM_BLE_CS_OFFSET)
#define BLE_TXCCMPKTCNT0_INDEX  0x0000001F
#define BLE_TXCCMPKTCNT0_RESET  0x00000000

__BLE_INLINE uint16_t ble_txccmpktcnt0_get(int elt_idx)
{
    return EM_BLE_RD(BLE_TXCCMPKTCNT0_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_txccmpktcnt0_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_txccmpktcnt0_getf(int elt_idx)
{
...
__BLE_INLINE void ble_txccmpktcnt0_setf(int elt_idx, uint16_t txccmpktcnt0)
{
 ...
 * </pre>
 */
#define BLE_TXCCMPKTCNT1_ADDR   (0x40006040 + EM_BLE_CS_OFFSET)
#define BLE_TXCCMPKTCNT1_INDEX  0x00000020
#define BLE_TXCCMPKTCNT1_RESET  0x00000000

__BLE_INLINE uint16_t ble_txccmpktcnt1_get(int elt_idx)
{
    return EM_BLE_RD(BLE_TXCCMPKTCNT1_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_txccmpktcnt1_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_txccmpktcnt1_getf(int elt_idx)
{
...
__BLE_INLINE void ble_txccmpktcnt1_setf(int elt_idx, uint16_t txccmpktcnt1)
{
 ...
 * </pre>
 */
#define BLE_TXCCMPKTCNT2_ADDR   (0x40006042 + EM_BLE_CS_OFFSET)
#define BLE_TXCCMPKTCNT2_INDEX  0x00000021
#define BLE_TXCCMPKTCNT2_RESET  0x00000000

__BLE_INLINE uint16_t ble_txccmpktcnt2_get(int elt_idx)
{
    return EM_BLE_RD(BLE_TXCCMPKTCNT2_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_txccmpktcnt2_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint8_t ble_txccmpktcnt2_getf(int elt_idx)
{
...
__BLE_INLINE void ble_txccmpktcnt2_setf(int elt_idx, uint8_t txccmpktcnt2)
{
 ...
 * </pre>
 */
#define BLE_RXCCMPKTCNT0_ADDR   (0x40006044 + EM_BLE_CS_OFFSET)
#define BLE_RXCCMPKTCNT0_INDEX  0x00000022
#define BLE_RXCCMPKTCNT0_RESET  0x00000000

__BLE_INLINE uint16_t ble_rxccmpktcnt0_get(int elt_idx)
{
    return EM_BLE_RD(BLE_RXCCMPKTCNT0_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_rxccmpktcnt0_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_rxccmpktcnt0_getf(int elt_idx)
{
...
__BLE_INLINE void ble_rxccmpktcnt0_setf(int elt_idx, uint16_t rxccmpktcnt0)
{
 ...
 * </pre>
 */
#define BLE_RXCCMPKTCNT1_ADDR   (0x40006046 + EM_BLE_CS_OFFSET)
#define BLE_RXCCMPKTCNT1_INDEX  0x00000023
#define BLE_RXCCMPKTCNT1_RESET  0x00000000

__BLE_INLINE uint16_t ble_rxccmpktcnt1_get(int elt_idx)
{
    return EM_BLE_RD(BLE_RXCCMPKTCNT1_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_rxccmpktcnt1_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_rxccmpktcnt1_getf(int elt_idx)
{
...
__BLE_INLINE void ble_rxccmpktcnt1_setf(int elt_idx, uint16_t rxccmpktcnt1)
{
 ...
 * </pre>
 */
#define BLE_RXCCMPKTCNT2_ADDR   (0x40006048 + EM_BLE_CS_OFFSET)
#define BLE_RXCCMPKTCNT2_INDEX  0x00000024
#define BLE_RXCCMPKTCNT2_RESET  0x00000000

__BLE_INLINE uint16_t ble_rxccmpktcnt2_get(int elt_idx)
{
    return EM_BLE_RD(BLE_RXCCMPKTCNT2_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_rxccmpktcnt2_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint8_t ble_rxccmpktcnt2_getf(int elt_idx)
{
...
__BLE_INLINE void ble_rxccmpktcnt2_setf(int elt_idx, uint8_t rxccmpktcnt2)
{
 ...
 * </pre>
 */
#define BLE_EVTCNT_ADDR   (0x4000604A + EM_BLE_CS_OFFSET)
#define BLE_EVTCNT_INDEX  0x00000025
#define BLE_EVTCNT_RESET  0x00000000

__BLE_INLINE uint16_t ble_evtcnt_get(int elt_idx)
{
    return EM_BLE_RD(BLE_EVTCNT_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_evtcnt_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_evt_cnt_getf(int elt_idx)
{
...
__BLE_INLINE void ble_evt_cnt_setf(int elt_idx, uint16_t evtcnt)
{
 ...
 * </pre>
 */
#define BLE_ISOTXRXCNTL_ADDR   (0x4000604C + EM_BLE_CS_OFFSET)
#define BLE_ISOTXRXCNTL_INDEX  0x00000026
#define BLE_ISOTXRXCNTL_RESET  0x00000000

__BLE_INLINE uint16_t ble_isotxrxcntl_get(int elt_idx)
{
    return EM_BLE_RD(BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_isotxrxcntl_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE void ble_isotxrxcntl_pack(int elt_idx, uint8_t isorxbufffull, uint8_t isolastempty, uint8_t isomd, uint8_t isosn, uint8_t isonesn, uint8_t isoretx, uint8_t isorsvd, uint8_t isowaitack, uint8_t isolastmd, uint8_t isolastnesn, uint8_t isolastsn)
{
...
__BLE_INLINE void ble_isotxrxcntl_unpack(int elt_idx, uint8_t* isorxbufffull, uint8_t* isolastempty, uint8_t* isomd, uint8_t* isosn, uint8_t* isonesn, uint8_t* isoretx, uint8_t* isorsvd, uint8_t* isowaitack, uint8_t* isolastmd, uint8_t* isolastnesn, uint8_t* isolastsn)
{
...
__BLE_INLINE uint8_t ble_isorxbuff_full_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__BLE_INLINE void ble_isorxbuff_full_setf(int elt_idx, uint8_t isorxbufffull)
{
    ASSERT_ERR((((uint16_t)isorxbufffull << 15) & ~((uint16_t)0x00008000)) == 0);
...
__BLE_INLINE uint8_t ble_isolastempty_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00004000)) >> 14);
}

__BLE_INLINE void ble_isolastempty_setf(int elt_idx, uint8_t isolastempty)
{
    ASSERT_ERR((((uint16_t)isolastempty << 14) & ~((uint16_t)0x00004000)) == 0);
...
__BLE_INLINE uint8_t ble_isomd_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00002000)) >> 13);
}

__BLE_INLINE void ble_isomd_setf(int elt_idx, uint8_t isomd)
{
    ASSERT_ERR((((uint16_t)isomd << 13) & ~((uint16_t)0x00002000)) == 0);
...
__BLE_INLINE uint8_t ble_isosn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00001000)) >> 12);
}

__BLE_INLINE void ble_isosn_setf(int elt_idx, uint8_t isosn)
{
    ASSERT_ERR((((uint16_t)isosn << 12) & ~((uint16_t)0x00001000)) == 0);
...
__BLE_INLINE uint8_t ble_isonesn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000800)) >> 11);
}

__BLE_INLINE void ble_isonesn_setf(int elt_idx, uint8_t isonesn)
{
    ASSERT_ERR((((uint16_t)isonesn << 11) & ~((uint16_t)0x00000800)) == 0);
...
__BLE_INLINE uint8_t ble_isoretx_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000200)) >> 9);
}

__BLE_INLINE void ble_isoretx_setf(int elt_idx, uint8_t isoretx)
{
    ASSERT_ERR((((uint16_t)isoretx << 9) & ~((uint16_t)0x00000200)) == 0);
...
__BLE_INLINE uint8_t ble_isorsvd_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000100)) >> 8);
}

__BLE_INLINE void ble_isorsvd_setf(int elt_idx, uint8_t isorsvd)
{
    ASSERT_ERR((((uint16_t)isorsvd << 8) & ~((uint16_t)0x00000100)) == 0);
...
__BLE_INLINE uint8_t ble_isowaitack_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000008)) >> 3);
}

__BLE_INLINE void ble_isowaitack_setf(int elt_idx, uint8_t isowaitack)
{
    ASSERT_ERR((((uint16_t)isowaitack << 3) & ~((uint16_t)0x00000008)) == 0);
...
__BLE_INLINE uint8_t ble_isolastmd_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000004)) >> 2);
}

__BLE_INLINE void ble_isolastmd_setf(int elt_idx, uint8_t isolastmd)
{
    ASSERT_ERR((((uint16_t)isolastmd << 2) & ~((uint16_t)0x00000004)) == 0);
...
__BLE_INLINE uint8_t ble_isolastnesn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000002)) >> 1);
}

__BLE_INLINE void ble_isolastnesn_setf(int elt_idx, uint8_t isolastnesn)
{
    ASSERT_ERR((((uint16_t)isolastnesn << 1) & ~((uint16_t)0x00000002)) == 0);
...
__BLE_INLINE uint8_t ble_isolastsn_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_ISOTXRXCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000001)) >> 0);
}

__BLE_INLINE void ble_isolastsn_setf(int elt_idx, uint8_t isolastsn)
{
    ASSERT_ERR((((uint16_t)isolastsn << 0) & ~((uint16_t)0x00000001)) == 0);
 ...
 * </pre>
 */
#define BLE_BTCNTSYNC0_ADDR   (0x4000604E + EM_BLE_CS_OFFSET)
#define BLE_BTCNTSYNC0_INDEX  0x00000027
#define BLE_BTCNTSYNC0_RESET  0x00000000

__BLE_INLINE uint16_t ble_btcntsync0_get(int elt_idx)
{
    return EM_BLE_RD(BLE_BTCNTSYNC0_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_btcntsync0_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_btcntsync0_getf(int elt_idx)
{
...
__BLE_INLINE void ble_btcntsync0_setf(int elt_idx, uint16_t btcntsync0)
{
 ...
 * </pre>
 */
#define BLE_BTCNTSYNC1_ADDR   (0x40006050 + EM_BLE_CS_OFFSET)
#define BLE_BTCNTSYNC1_INDEX  0x00000028
#define BLE_BTCNTSYNC1_RESET  0x00000000

__BLE_INLINE uint16_t ble_btcntsync1_get(int elt_idx)
{
    return EM_BLE_RD(BLE_BTCNTSYNC1_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_btcntsync1_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE uint16_t ble_btcntsync1_getf(int elt_idx)
{
...
__BLE_INLINE void ble_btcntsync1_setf(int elt_idx, uint16_t btcntsync1)
{
 ...
 * </pre>
 */
#define BLE_FCNTSYNC_ADDR   (0x40006052 + EM_BLE_CS_OFFSET)
#define BLE_FCNTSYNC_INDEX  0x00000029
#define BLE_FCNTSYNC_RESET  0x00000000

__BLE_INLINE uint16_t ble_fcntsync_get(int elt_idx)
{
    return EM_BLE_RD(BLE_FCNTSYNC_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_fcntsync_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE void ble_fcntsync_unpack(int elt_idx, uint8_t* evtrxok, uint16_t* fcntrxsync)
{
...
__BLE_INLINE uint8_t ble_evtrxok_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_FCNTSYNC_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__BLE_INLINE uint16_t ble_fcntrxsync_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_FCNTSYNC_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x000003FF)) >> 0);
}

__BLE_INLINE void ble_fcntrxsync_setf(int elt_idx, uint16_t fcntrxsync)
{
 ...
 * </pre>
 */
#define BLE_TXRXDESCCNT_ADDR   (0x40006054 + EM_BLE_CS_OFFSET)
#define BLE_TXRXDESCCNT_INDEX  0x0000002A
#define BLE_TXRXDESCCNT_RESET  0x00000000

__BLE_INLINE uint16_t ble_txrxdesccnt_get(int elt_idx)
{
    return EM_BLE_RD(BLE_TXRXDESCCNT_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_txrxdesccnt_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE void ble_txrxdesccnt_pack(int elt_idx, uint8_t aclrxdesccnt, uint8_t acltxdesccnt)
{
...
__BLE_INLINE void ble_txrxdesccnt_unpack(int elt_idx, uint8_t* aclrxdesccnt, uint8_t* acltxdesccnt)
{
...
__BLE_INLINE uint8_t ble_aclrxdesccnt_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_TXRXDESCCNT_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000FF00)) >> 8);
}

__BLE_INLINE void ble_aclrxdesccnt_setf(int elt_idx, uint8_t aclrxdesccnt)
{
    ASSERT_ERR((((uint16_t)aclrxdesccnt << 8) & ~((uint16_t)0x0000FF00)) == 0);
...
__BLE_INLINE uint8_t ble_acltxdesccnt_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_TXRXDESCCNT_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x000000FF)) >> 0);
}

__BLE_INLINE void ble_acltxdesccnt_setf(int elt_idx, uint8_t acltxdesccnt)
{
    ASSERT_ERR((((uint16_t)acltxdesccnt << 0) & ~((uint16_t)0x000000FF)) == 0);
 ...
 * </pre>
 */
#define BLE_ISOTXRXPKTCNT_ADDR   (0x40006056 + EM_BLE_CS_OFFSET)
#define BLE_ISOTXRXPKTCNT_INDEX  0x0000002B
#define BLE_ISOTXRXPKTCNT_RESET  0x00000000

__BLE_INLINE uint16_t ble_isotxrxpktcnt_get(int elt_idx)
{
    return EM_BLE_RD(BLE_ISOTXRXPKTCNT_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_isotxrxpktcnt_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE void ble_isotxrxpktcnt_pack(int elt_idx, uint8_t isorxpktcntl, uint8_t isotxpktcntl)
{
...
__BLE_INLINE void ble_isotxrxpktcnt_unpack(int elt_idx, uint8_t* isorxpktcntl, uint8_t* isotxpktcntl)
{
...
__BLE_INLINE uint8_t ble_isorxpktcntl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_ISOTXRXPKTCNT_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000FF00)) >> 8);
}

__BLE_INLINE void ble_isorxpktcntl_setf(int elt_idx, uint8_t isorxpktcntl)
{
    ASSERT_ERR((((uint16_t)isorxpktcntl << 8) & ~((uint16_t)0x0000FF00)) == 0);
...
__BLE_INLINE uint8_t ble_isotxpktcntl_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_ISOTXRXPKTCNT_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x000000FF)) >> 0);
}

__BLE_INLINE void ble_isotxpktcntl_setf(int elt_idx, uint8_t isotxpktcntl)
{
    ASSERT_ERR((((uint16_t)isotxpktcntl << 0) & ~((uint16_t)0x000000FF)) == 0);
 ...
 * </pre>
 */
#define BLE_DMPRIOCNTL_ADDR   (0x40006058 + EM_BLE_CS_OFFSET)
#define BLE_DMPRIOCNTL_INDEX  0x0000002C
#define BLE_DMPRIOCNTL_RESET  0x00000000

__BLE_INLINE uint16_t ble_dmpriocntl_get(int elt_idx)
{
    return EM_BLE_RD(BLE_DMPRIOCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
}

__BLE_INLINE void ble_dmpriocntl_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE void ble_dmpriocntl_pack(int elt_idx, uint8_t prioincstep, uint8_t minprio, uint8_t conflict, uint8_t currentprio)
{
...
__BLE_INLINE void ble_dmpriocntl_unpack(int elt_idx, uint8_t* prioincstep, uint8_t* minprio, uint8_t* conflict, uint8_t* currentprio)
{
...
__BLE_INLINE uint8_t ble_prioincstep_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_DMPRIOCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000E000)) >> 13);
}

__BLE_INLINE void ble_prioincstep_setf(int elt_idx, uint8_t prioincstep)
{
    ASSERT_ERR((((uint16_t)prioincstep << 13) & ~((uint16_t)0x0000E000)) == 0);
...
__BLE_INLINE uint8_t ble_minprio_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_DMPRIOCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00001F00)) >> 8);
}

__BLE_INLINE void ble_minprio_setf(int elt_idx, uint8_t minprio)
{
    ASSERT_ERR((((uint16_t)minprio << 8) & ~((uint16_t)0x00001F00)) == 0);
...
__BLE_INLINE uint8_t ble_conflict_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_DMPRIOCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x00000080)) >> 7);
}

__BLE_INLINE void ble_conflict_setf(int elt_idx, uint8_t conflict)
{
    ASSERT_ERR((((uint16_t)conflict << 7) & ~((uint16_t)0x00000080)) == 0);
...
__BLE_INLINE uint8_t ble_currentprio_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_DMPRIOCNTL_ADDR + elt_idx * REG_BLE_EM_CS_SIZE);
    return ((localVal & ((uint16_t)0x0000001F)) >> 0);
}

__BLE_INLINE void ble_currentprio_setf(int elt_idx, uint8_t currentprio)
{
    ASSERT_ERR((((uint16_t)currentprio << 0) & ~((uint16_t)0x0000001F)) == 0);
