...
__BLE_INLINE uint16_t ble_rxaudiobuf_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 31);
...
__BLE_INLINE void ble_rxaudiobuf_setf(int elt_idx, int reg_idx, uint16_t rxaudiobuf)
{
    ASSERT_ERR(reg_idx <= 31);
