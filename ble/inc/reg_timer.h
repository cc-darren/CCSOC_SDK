...
__BLE_INLINE uint32_t tmr_timer_ctrl_get(void)
{
    return REG_PL_RD(TMR_TIMER_CTRL_ADDR);
}

__BLE_INLINE void tmr_timer_ctrl_set(uint32_t value)
{
...
__BLE_INLINE void tmr_timer_ctrl_pack(uint8_t enable, uint8_t reset, uint32_t unitinus)
{
...
__BLE_INLINE void tmr_timer_ctrl_unpack(uint8_t* enable, uint8_t* reset, uint32_t* unitinus)
{
...
__BLE_INLINE uint8_t tmr_enable_getf(void)
{
    uint32_t localVal = REG_PL_RD(TMR_TIMER_CTRL_ADDR);
    return ((localVal & ((uint32_t)0x80000000)) >> 31);
}

__BLE_INLINE void tmr_enable_setf(uint8_t enable)
{
    ASSERT_ERR((((uint32_t)enable << 31) & ~((uint32_t)0x80000000)) == 0);
    REG_PL_WR(TMR_TIMER_CTRL_ADDR, (REG_PL_RD(TMR_TIMER_CTRL_ADDR) & ~((uint32_t)0x80000000)) | ((uint32_t)enable << 31));
}

__BLE_INLINE uint8_t tmr_reset_getf(void)
{
    uint32_t localVal = REG_PL_RD(TMR_TIMER_CTRL_ADDR);
    return ((localVal & ((uint32_t)0x40000000)) >> 30);
}

__BLE_INLINE void tmr_reset_setf(uint8_t reset)
{
    ASSERT_ERR((((uint32_t)reset << 30) & ~((uint32_t)0x40000000)) == 0);
    REG_PL_WR(TMR_TIMER_CTRL_ADDR, (REG_PL_RD(TMR_TIMER_CTRL_ADDR) & ~((uint32_t)0x40000000)) | ((uint32_t)reset << 30));
}

__BLE_INLINE uint32_t tmr_unit_in_us_getf(void)
{
    uint32_t localVal = REG_PL_RD(TMR_TIMER_CTRL_ADDR);
    return ((localVal & ((uint32_t)0x0FFFFFFF)) >> 0);
}

__BLE_INLINE void tmr_unit_in_us_setf(uint32_t unitinus)
{
    ASSERT_ERR((((uint32_t)unitinus << 0) & ~((uint32_t)0x0FFFFFFF)) == 0);
...
__BLE_INLINE uint32_t tmr_current_time_get(void)
{
    return REG_PL_RD(TMR_CURRENT_TIME_ADDR);
}

__BLE_INLINE void tmr_current_time_set(uint32_t value)
{
...
__BLE_INLINE uint32_t tmr_time_getf(void)
{
...
__BLE_INLINE uint32_t tmr_end_time_get(void)
{
    return REG_PL_RD(TMR_END_TIME_ADDR);
}

__BLE_INLINE void tmr_end_time_set(uint32_t value)
{
...
__BLE_INLINE uint32_t tmr_end_time_getf(void)
{
...
__BLE_INLINE void tmr_end_time_setf(uint32_t endtime)
{
...
__BLE_INLINE uint32_t tmr_periodic_time_get(void)
{
    return REG_PL_RD(TMR_PERIODIC_TIME_ADDR);
}

__BLE_INLINE void tmr_periodic_time_set(uint32_t value)
{
...
__BLE_INLINE uint32_t tmr_period_getf(void)
{
...
__BLE_INLINE void tmr_period_setf(uint32_t period)
{
...
__BLE_INLINE uint32_t tmr_isr_status_get(void)
{
...
__BLE_INLINE void tmr_isr_status_unpack(uint8_t* periodicstat, uint8_t* endtimestat)
{
...
__BLE_INLINE uint8_t tmr_periodic_stat_getf(void)
{
    uint32_t localVal = REG_PL_RD(TMR_ISR_STATUS_ADDR);
    return ((localVal & ((uint32_t)0x00000002)) >> 1);
}

__BLE_INLINE uint8_t tmr_end_time_stat_getf(void)
{
    uint32_t localVal = REG_PL_RD(TMR_ISR_STATUS_ADDR);
...
__BLE_INLINE uint32_t tmr_isr_en_get(void)
{
    return REG_PL_RD(TMR_ISR_EN_ADDR);
}

__BLE_INLINE void tmr_isr_en_set(uint32_t value)
{
...
__BLE_INLINE void tmr_isr_en_pack(uint8_t periodicen, uint8_t endtimeen)
{
...
__BLE_INLINE void tmr_isr_en_unpack(uint8_t* periodicen, uint8_t* endtimeen)
{
...
__BLE_INLINE uint8_t tmr_periodic_en_getf(void)
{
    uint32_t localVal = REG_PL_RD(TMR_ISR_EN_ADDR);
    return ((localVal & ((uint32_t)0x00000002)) >> 1);
}

__BLE_INLINE void tmr_periodic_en_setf(uint8_t periodicen)
{
    ASSERT_ERR((((uint32_t)periodicen << 1) & ~((uint32_t)0x00000002)) == 0);
    REG_PL_WR(TMR_ISR_EN_ADDR, (REG_PL_RD(TMR_ISR_EN_ADDR) & ~((uint32_t)0x00000002)) | ((uint32_t)periodicen << 1));
}

__BLE_INLINE uint8_t tmr_end_time_en_getf(void)
{
    uint32_t localVal = REG_PL_RD(TMR_ISR_EN_ADDR);
    return ((localVal & ((uint32_t)0x00000001)) >> 0);
}

__BLE_INLINE void tmr_end_time_en_setf(uint8_t endtimeen)
{
    ASSERT_ERR((((uint32_t)endtimeen << 0) & ~((uint32_t)0x00000001)) == 0);
...
__BLE_INLINE uint32_t tmr_isr_clr_get(void)
{
    return REG_PL_RD(TMR_ISR_CLR_ADDR);
}

__BLE_INLINE void tmr_isr_clr_set(uint32_t value)
{
...
__BLE_INLINE void tmr_isr_clr_pack(uint8_t periodicclr, uint8_t endtimeclr)
{
...
__BLE_INLINE void tmr_isr_clr_unpack(uint8_t* periodicclr, uint8_t* endtimeclr)
{
...
__BLE_INLINE void tmr_periodic_clr_setf(uint8_t periodicclr)
{
    ASSERT_ERR((((uint32_t)periodicclr << 1) & ~((uint32_t)0x00000002)) == 0);
    REG_PL_WR(TMR_ISR_CLR_ADDR, (REG_PL_RD(TMR_ISR_CLR_ADDR) & ~((uint32_t)0x00000002)) | ((uint32_t)periodicclr << 1));
}

__BLE_INLINE void tmr_end_time_clr_setf(uint8_t endtimeclr)
{
    ASSERT_ERR((((uint32_t)endtimeclr << 0) & ~((uint32_t)0x00000001)) == 0);
