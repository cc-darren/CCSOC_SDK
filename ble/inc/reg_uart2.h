...
__BLE_INLINE uint32_t uart2_ctrl_get(void)
{
    return REG_PL_RD(UART2_CTRL_ADDR);
}

__BLE_INLINE void uart2_ctrl_set(uint32_t value)
{
...
__BLE_INLINE void uart2_ctrl_pack(uint8_t clkdivfracp, uint8_t clkdivintp, uint8_t cntval, uint8_t cntstart, uint8_t extwakeupen, uint8_t forcerts)
{
...
__BLE_INLINE void uart2_ctrl_unpack(uint8_t* clkdivfracp, uint8_t* clkdivintp, uint8_t* cntval, uint8_t* cntstart, uint8_t* extwakeupen, uint8_t* forcerts)
{
...
__BLE_INLINE uint8_t uart2_clk_div_fracp_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_CTRL_ADDR);
    return ((localVal & ((uint32_t)0xFF000000)) >> 24);
}

__BLE_INLINE void uart2_clk_div_fracp_setf(uint8_t clkdivfracp)
{
    ASSERT_ERR((((uint32_t)clkdivfracp << 24) & ~((uint32_t)0xFF000000)) == 0);
    REG_PL_WR(UART2_CTRL_ADDR, (REG_PL_RD(UART2_CTRL_ADDR) & ~((uint32_t)0xFF000000)) | ((uint32_t)clkdivfracp << 24));
}

__BLE_INLINE uint8_t uart2_clk_div_intp_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_CTRL_ADDR);
    return ((localVal & ((uint32_t)0x00FF0000)) >> 16);
}

__BLE_INLINE void uart2_clk_div_intp_setf(uint8_t clkdivintp)
{
    ASSERT_ERR((((uint32_t)clkdivintp << 16) & ~((uint32_t)0x00FF0000)) == 0);
    REG_PL_WR(UART2_CTRL_ADDR, (REG_PL_RD(UART2_CTRL_ADDR) & ~((uint32_t)0x00FF0000)) | ((uint32_t)clkdivintp << 16));
}

__BLE_INLINE uint8_t uart2_cnt_val_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_CTRL_ADDR);
    return ((localVal & ((uint32_t)0x0000FF00)) >> 8);
}

__BLE_INLINE void uart2_cnt_val_setf(uint8_t cntval)
{
    ASSERT_ERR((((uint32_t)cntval << 8) & ~((uint32_t)0x0000FF00)) == 0);
    REG_PL_WR(UART2_CTRL_ADDR, (REG_PL_RD(UART2_CTRL_ADDR) & ~((uint32_t)0x0000FF00)) | ((uint32_t)cntval << 8));
}

__BLE_INLINE void uart2_cnt_start_setf(uint8_t cntstart)
{
    ASSERT_ERR((((uint32_t)cntstart << 4) & ~((uint32_t)0x00000010)) == 0);
    REG_PL_WR(UART2_CTRL_ADDR, (REG_PL_RD(UART2_CTRL_ADDR) & ~((uint32_t)0x00000010)) | ((uint32_t)cntstart << 4));
}

__BLE_INLINE uint8_t uart2_ext_wakeup_en_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_CTRL_ADDR);
    return ((localVal & ((uint32_t)0x00000002)) >> 1);
}

__BLE_INLINE void uart2_ext_wakeup_en_setf(uint8_t extwakeupen)
{
    ASSERT_ERR((((uint32_t)extwakeupen << 1) & ~((uint32_t)0x00000002)) == 0);
    REG_PL_WR(UART2_CTRL_ADDR, (REG_PL_RD(UART2_CTRL_ADDR) & ~((uint32_t)0x00000002)) | ((uint32_t)extwakeupen << 1));
}

__BLE_INLINE uint8_t uart2_force_rts_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_CTRL_ADDR);
    return ((localVal & ((uint32_t)0x00000001)) >> 0);
}

__BLE_INLINE void uart2_force_rts_setf(uint8_t forcerts)
{
    ASSERT_ERR((((uint32_t)forcerts << 0) & ~((uint32_t)0x00000001)) == 0);
...
__BLE_INLINE uint32_t uart2_stat_get(void)
{
...
__BLE_INLINE void uart2_stat_unpack(uint8_t* txdmastarted, uint8_t* rxdmastarted, uint8_t* extwakeup, uint8_t* cntend, uint8_t* txfifoempty, uint8_t* rxfifonotempty, uint8_t* cts, uint8_t* rts)
{
...
__BLE_INLINE uint8_t uart2_tx_dma_started_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_STAT_ADDR);
    return ((localVal & ((uint32_t)0x00000200)) >> 9);
}

__BLE_INLINE uint8_t uart2_rx_dma_started_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_STAT_ADDR);
    return ((localVal & ((uint32_t)0x00000100)) >> 8);
}

__BLE_INLINE uint8_t uart2_ext_wakeup_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_STAT_ADDR);
    return ((localVal & ((uint32_t)0x00000020)) >> 5);
}

__BLE_INLINE uint8_t uart2_cnt_end_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_STAT_ADDR);
    return ((localVal & ((uint32_t)0x00000010)) >> 4);
}

__BLE_INLINE uint8_t uart2_tx_fifo_empty_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_STAT_ADDR);
    return ((localVal & ((uint32_t)0x00000008)) >> 3);
}

__BLE_INLINE uint8_t uart2_rx_fifo_not_empty_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_STAT_ADDR);
    return ((localVal & ((uint32_t)0x00000004)) >> 2);
}

__BLE_INLINE uint8_t uart2_cts_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_STAT_ADDR);
    return ((localVal & ((uint32_t)0x00000002)) >> 1);
}

__BLE_INLINE uint8_t uart2_rts_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_STAT_ADDR);
    return ((localVal & ((uint32_t)0x00000001)) >> 0);
}
...
__BLE_INLINE uint32_t uart2_clk_get(void)
{
...
__BLE_INLINE uint32_t uart2_freq_getf(void)
{
...
__BLE_INLINE uint32_t uart2_isr_stat_get(void)
{
...
__BLE_INLINE void uart2_isr_stat_unpack(uint8_t* txdmadone, uint8_t* rxdmadone, uint8_t* breakisr, uint8_t* txfifoemptyisr, uint8_t* rxfifonotemptyisr)
{
...
__BLE_INLINE uint8_t uart2_tx_dma_done_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_ISR_STAT_ADDR);
    return ((localVal & ((uint32_t)0x00000040)) >> 6);
}

__BLE_INLINE uint8_t uart2_rx_dma_done_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_ISR_STAT_ADDR);
    return ((localVal & ((uint32_t)0x00000020)) >> 5);
}

__BLE_INLINE uint8_t uart2_break_isr_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_ISR_STAT_ADDR);
    return ((localVal & ((uint32_t)0x00000010)) >> 4);
}

__BLE_INLINE uint8_t uart2_tx_fifo_empty_isr_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_ISR_STAT_ADDR);
    return ((localVal & ((uint32_t)0x00000002)) >> 1);
}

__BLE_INLINE uint8_t uart2_rx_fifo_not_empty_isr_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_ISR_STAT_ADDR);
    return ((localVal & ((uint32_t)0x00000001)) >> 0);
}
...
__BLE_INLINE uint32_t uart2_isr_en_get(void)
{
    return REG_PL_RD(UART2_ISR_EN_ADDR);
}

__BLE_INLINE void uart2_isr_en_set(uint32_t value)
{
...
__BLE_INLINE void uart2_isr_en_pack(uint8_t txdmadoneen, uint8_t rxdmadoneen, uint8_t breaken, uint8_t txfifoemptyen, uint8_t rxfifonotemptyen)
{
...
__BLE_INLINE void uart2_isr_en_unpack(uint8_t* txdmadoneen, uint8_t* rxdmadoneen, uint8_t* breaken, uint8_t* txfifoemptyen, uint8_t* rxfifonotemptyen)
{
...
__BLE_INLINE uint8_t uart2_tx_dma_done_en_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_ISR_EN_ADDR);
    return ((localVal & ((uint32_t)0x00000040)) >> 6);
}

__BLE_INLINE void uart2_tx_dma_done_en_setf(uint8_t txdmadoneen)
{
    ASSERT_ERR((((uint32_t)txdmadoneen << 6) & ~((uint32_t)0x00000040)) == 0);
    REG_PL_WR(UART2_ISR_EN_ADDR, (REG_PL_RD(UART2_ISR_EN_ADDR) & ~((uint32_t)0x00000040)) | ((uint32_t)txdmadoneen << 6));
}

__BLE_INLINE uint8_t uart2_rx_dma_done_en_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_ISR_EN_ADDR);
    return ((localVal & ((uint32_t)0x00000020)) >> 5);
}

__BLE_INLINE void uart2_rx_dma_done_en_setf(uint8_t rxdmadoneen)
{
    ASSERT_ERR((((uint32_t)rxdmadoneen << 5) & ~((uint32_t)0x00000020)) == 0);
    REG_PL_WR(UART2_ISR_EN_ADDR, (REG_PL_RD(UART2_ISR_EN_ADDR) & ~((uint32_t)0x00000020)) | ((uint32_t)rxdmadoneen << 5));
}

__BLE_INLINE uint8_t uart2_break_en_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_ISR_EN_ADDR);
    return ((localVal & ((uint32_t)0x00000010)) >> 4);
}

__BLE_INLINE void uart2_break_en_setf(uint8_t breaken)
{
    ASSERT_ERR((((uint32_t)breaken << 4) & ~((uint32_t)0x00000010)) == 0);
    REG_PL_WR(UART2_ISR_EN_ADDR, (REG_PL_RD(UART2_ISR_EN_ADDR) & ~((uint32_t)0x00000010)) | ((uint32_t)breaken << 4));
}

__BLE_INLINE uint8_t uart2_tx_fifo_empty_en_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_ISR_EN_ADDR);
    return ((localVal & ((uint32_t)0x00000002)) >> 1);
}

__BLE_INLINE void uart2_tx_fifo_empty_en_setf(uint8_t txfifoemptyen)
{
    ASSERT_ERR((((uint32_t)txfifoemptyen << 1) & ~((uint32_t)0x00000002)) == 0);
    REG_PL_WR(UART2_ISR_EN_ADDR, (REG_PL_RD(UART2_ISR_EN_ADDR) & ~((uint32_t)0x00000002)) | ((uint32_t)txfifoemptyen << 1));
}

__BLE_INLINE uint8_t uart2_rx_fifo_not_empty_en_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_ISR_EN_ADDR);
    return ((localVal & ((uint32_t)0x00000001)) >> 0);
}

__BLE_INLINE void uart2_rx_fifo_not_empty_en_setf(uint8_t rxfifonotemptyen)
{
    ASSERT_ERR((((uint32_t)rxfifonotemptyen << 0) & ~((uint32_t)0x00000001)) == 0);
...
__BLE_INLINE void uart2_isr_clr_set(uint32_t value)
{
...
__BLE_INLINE void uart2_isr_clr_pack(uint8_t txdmadoneclr, uint8_t rxdmadoneclr, uint8_t breakclr, uint8_t txfifoemptyclr, uint8_t rxfifonotemptyclr)
{
...
__BLE_INLINE uint32_t uart2_rx_dma_get(void)
{
    return REG_PL_RD(UART2_RX_DMA_ADDR);
}

__BLE_INLINE void uart2_rx_dma_set(uint32_t value)
{
...
__BLE_INLINE uint32_t uart2_rx_ptr_getf(void)
{
...
__BLE_INLINE void uart2_rx_ptr_setf(uint32_t rxptr)
{
...
__BLE_INLINE uint32_t uart2_tx_dma_get(void)
{
    return REG_PL_RD(UART2_TX_DMA_ADDR);
}

__BLE_INLINE void uart2_tx_dma_set(uint32_t value)
{
...
__BLE_INLINE uint32_t uart2_tx_ptr_getf(void)
{
...
__BLE_INLINE void uart2_tx_ptr_setf(uint32_t txptr)
{
...
__BLE_INLINE uint32_t uart2_dma_ctrl_get(void)
{
    return REG_PL_RD(UART2_DMA_CTRL_ADDR);
}

__BLE_INLINE void uart2_dma_ctrl_set(uint32_t value)
{
...
__BLE_INLINE void uart2_dma_ctrl_pack(uint8_t txstart, uint16_t txsize, uint8_t rxstart, uint16_t rxsize)
{
...
__BLE_INLINE void uart2_dma_ctrl_unpack(uint8_t* txstart, uint16_t* txsize, uint8_t* rxstart, uint16_t* rxsize)
{
