...
__BLE_INLINE uint32_t intc_irqstatus_get(void)
{
...
__BLE_INLINE uint32_t intc_irqstatus_irqstat_getf(void)
{
...
__BLE_INLINE uint32_t intc_irqrawstatus_get(void)
{
...
__BLE_INLINE uint32_t intc_irqrawstatus_irqrawstat_getf(void)
{
...
__BLE_INLINE uint32_t intc_irqenableset_get(void)
{
    return REG_PL_RD(INTC_IRQENABLESET_ADDR);
}

__BLE_INLINE void intc_irqenableset_set(uint32_t value)
{
...
__BLE_INLINE uint32_t intc_irqenableset_getf(void)
{
...
__BLE_INLINE void intc_irqenableset_setf(uint32_t irqenableset)
{
...
__BLE_INLINE void intc_irqenableclear_set(uint32_t value)
{
...
__BLE_INLINE void intc_irqenableclear_setf(uint32_t irqenableclear)
{
...
__BLE_INLINE uint32_t intc_irqsoft_get(void)
{
    return REG_PL_RD(INTC_IRQSOFT_ADDR);
}

__BLE_INLINE void intc_irqsoft_set(uint32_t value)
{
...
__BLE_INLINE void intc_irqsoft_irqsft_setf(uint8_t irqsft)
{
...
__BLE_INLINE void intc_irqack_set(uint32_t value)
{
...
__BLE_INLINE void intc_irqack_setf(uint32_t irqack)
{
...
__BLE_INLINE uint32_t intc_irqindex_get(void)
{
...
__BLE_INLINE uint8_t intc_irqindex_getf(void)
{
...
__BLE_INLINE uint32_t intc_fiqstatus_get(void)
{
...
__BLE_INLINE uint32_t intc_fiqstatus_fiqstat_getf(void)
{
...
__BLE_INLINE uint32_t intc_fiqrawstatus_get(void)
{
...
__BLE_INLINE uint32_t intc_fiqrawstatus_fiqrawstat_getf(void)
{
...
__BLE_INLINE uint32_t intc_fiqenableset_get(void)
{
    return REG_PL_RD(INTC_FIQENABLESET_ADDR);
}

__BLE_INLINE void intc_fiqenableset_set(uint32_t value)
{
...
__BLE_INLINE uint32_t intc_fiqenableset_getf(void)
{
...
__BLE_INLINE void intc_fiqenableset_setf(uint32_t fiqenableset)
{
...
__BLE_INLINE void intc_fiqenableclear_set(uint32_t value)
{
...
__BLE_INLINE void intc_fiqenableclear_setf(uint32_t fiqenableclear)
{
...
__BLE_INLINE void intc_fiqack_set(uint32_t value)
{
...
__BLE_INLINE void intc_fiqack_setf(uint32_t fiqack)
{
...
__BLE_INLINE uint32_t intc_fiqindex_get(void)
{
    return REG_PL_RD(INTC_FIQINDEX_ADDR);
}

__BLE_INLINE void intc_fiqindex_set(uint32_t value)
{
...
__BLE_INLINE uint8_t intc_fiqindex_getf(void)
{
