 ...
 * </pre>
 */
#define BLE_RAL_INFO_ADDR   (0x40006000 + EM_BLE_RAL_OFFSET)
#define BLE_RAL_INFO_INDEX  0x00000000
#define BLE_RAL_INFO_RESET  0x00000000

__BLE_INLINE uint16_t ble_ral_info_get(int elt_idx)
{
    return EM_BLE_RD(BLE_RAL_INFO_ADDR + elt_idx * REG_BLE_EM_RAL_SIZE);
}

__BLE_INLINE void ble_ral_info_set(int elt_idx, uint16_t value)
{
...
__BLE_INLINE void ble_ral_info_pack(int elt_idx, uint8_t entryvalid, uint8_t connected, uint8_t inwhlist, uint8_t localrpavalid, uint8_t localrparenew, uint8_t localirkvalid, uint8_t peerrpavalid, uint8_t peerrparenew, uint8_t peerirkvalid, uint8_t peeridtype)
{
...
__BLE_INLINE void ble_ral_info_unpack(int elt_idx, uint8_t* entryvalid, uint8_t* connected, uint8_t* inwhlist, uint8_t* localrpavalid, uint8_t* localrparenew, uint8_t* localirkvalid, uint8_t* peerrpavalid, uint8_t* peerrparenew, uint8_t* peerirkvalid, uint8_t* peeridtype)
{
...
__BLE_INLINE uint8_t ble_entry_valid_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_RAL_INFO_ADDR + elt_idx * REG_BLE_EM_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00008000)) >> 15);
}

__BLE_INLINE void ble_entry_valid_setf(int elt_idx, uint8_t entryvalid)
{
    ASSERT_ERR((((uint16_t)entryvalid << 15) & ~((uint16_t)0x00008000)) == 0);
...
__BLE_INLINE uint8_t ble_connected_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_RAL_INFO_ADDR + elt_idx * REG_BLE_EM_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00004000)) >> 14);
}

__BLE_INLINE void ble_connected_setf(int elt_idx, uint8_t connected)
{
    ASSERT_ERR((((uint16_t)connected << 14) & ~((uint16_t)0x00004000)) == 0);
...
__BLE_INLINE uint8_t ble_in_whlist_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_RAL_INFO_ADDR + elt_idx * REG_BLE_EM_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00002000)) >> 13);
}

__BLE_INLINE void ble_in_whlist_setf(int elt_idx, uint8_t inwhlist)
{
    ASSERT_ERR((((uint16_t)inwhlist << 13) & ~((uint16_t)0x00002000)) == 0);
...
__BLE_INLINE uint8_t ble_local_rpa_valid_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_RAL_INFO_ADDR + elt_idx * REG_BLE_EM_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00000080)) >> 7);
}

__BLE_INLINE void ble_local_rpa_valid_setf(int elt_idx, uint8_t localrpavalid)
{
    ASSERT_ERR((((uint16_t)localrpavalid << 7) & ~((uint16_t)0x00000080)) == 0);
...
__BLE_INLINE uint8_t ble_local_rpa_renew_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_RAL_INFO_ADDR + elt_idx * REG_BLE_EM_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00000040)) >> 6);
}

__BLE_INLINE void ble_local_rpa_renew_setf(int elt_idx, uint8_t localrparenew)
{
    ASSERT_ERR((((uint16_t)localrparenew << 6) & ~((uint16_t)0x00000040)) == 0);
...
__BLE_INLINE uint8_t ble_local_irk_valid_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_RAL_INFO_ADDR + elt_idx * REG_BLE_EM_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00000020)) >> 5);
}

__BLE_INLINE void ble_local_irk_valid_setf(int elt_idx, uint8_t localirkvalid)
{
    ASSERT_ERR((((uint16_t)localirkvalid << 5) & ~((uint16_t)0x00000020)) == 0);
...
__BLE_INLINE uint8_t ble_peer_rpa_valid_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_RAL_INFO_ADDR + elt_idx * REG_BLE_EM_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00000008)) >> 3);
}

__BLE_INLINE void ble_peer_rpa_valid_setf(int elt_idx, uint8_t peerrpavalid)
{
    ASSERT_ERR((((uint16_t)peerrpavalid << 3) & ~((uint16_t)0x00000008)) == 0);
...
__BLE_INLINE uint8_t ble_peer_rpa_renew_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_RAL_INFO_ADDR + elt_idx * REG_BLE_EM_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00000004)) >> 2);
}

__BLE_INLINE void ble_peer_rpa_renew_setf(int elt_idx, uint8_t peerrparenew)
{
    ASSERT_ERR((((uint16_t)peerrparenew << 2) & ~((uint16_t)0x00000004)) == 0);
...
__BLE_INLINE uint8_t ble_peer_irk_valid_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_RAL_INFO_ADDR + elt_idx * REG_BLE_EM_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00000002)) >> 1);
}

__BLE_INLINE void ble_peer_irk_valid_setf(int elt_idx, uint8_t peerirkvalid)
{
    ASSERT_ERR((((uint16_t)peerirkvalid << 1) & ~((uint16_t)0x00000002)) == 0);
...
__BLE_INLINE uint8_t ble_peer_id_type_getf(int elt_idx)
{
    uint16_t localVal = EM_BLE_RD(BLE_RAL_INFO_ADDR + elt_idx * REG_BLE_EM_RAL_SIZE);
    return ((localVal & ((uint16_t)0x00000001)) >> 0);
}

__BLE_INLINE void ble_peer_id_type_setf(int elt_idx, uint8_t peeridtype)
{
    ASSERT_ERR((((uint16_t)peeridtype << 0) & ~((uint16_t)0x00000001)) == 0);
...
__BLE_INLINE uint16_t ble_peer_irk_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 7);
...
__BLE_INLINE void ble_peer_irk_setf(int elt_idx, int reg_idx, uint16_t peerirk)
{
    ASSERT_ERR(reg_idx <= 7);
...
__BLE_INLINE uint16_t ble_peer_rpa_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 2);
...
__BLE_INLINE void ble_peer_rpa_setf(int elt_idx, int reg_idx, uint16_t peerrpa)
{
    ASSERT_ERR(reg_idx <= 2);
 ...
 * </pre>
 */
#define BLE_RAL_PEER_ID_ADDR   (0x40006018 + EM_BLE_RAL_OFFSET)
#define BLE_RAL_PEER_ID_INDEX  0x0000000C
#define BLE_RAL_PEER_ID_RESET  0x00000000
#define BLE_RAL_PEER_ID_COUNT  3

__BLE_INLINE uint16_t ble_ral_peer_id_get(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 2);
    return EM_BLE_RD(BLE_RAL_PEER_ID_ADDR + elt_idx * REG_BLE_EM_RAL_SIZE + reg_idx * 2);
}

__BLE_INLINE void ble_ral_peer_id_set(int elt_idx, int reg_idx, uint16_t value)
{
    ASSERT_ERR(reg_idx <= 2);
...
__BLE_INLINE uint16_t ble_peer_id_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 2);
...
__BLE_INLINE void ble_peer_id_setf(int elt_idx, int reg_idx, uint16_t peerid)
{
    ASSERT_ERR(reg_idx <= 2);
 ...
 * </pre>
 */
#define BLE_RAL_LOCAL_IRK_ADDR   (0x4000601E + EM_BLE_RAL_OFFSET)
#define BLE_RAL_LOCAL_IRK_INDEX  0x0000000F
#define BLE_RAL_LOCAL_IRK_RESET  0x00000000
#define BLE_RAL_LOCAL_IRK_COUNT  8

__BLE_INLINE uint16_t ble_ral_local_irk_get(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 7);
    return EM_BLE_RD(BLE_RAL_LOCAL_IRK_ADDR + elt_idx * REG_BLE_EM_RAL_SIZE + reg_idx * 2);
}

__BLE_INLINE void ble_ral_local_irk_set(int elt_idx, int reg_idx, uint16_t value)
{
    ASSERT_ERR(reg_idx <= 7);
...
__BLE_INLINE uint16_t ble_local_irk_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 7);
...
__BLE_INLINE void ble_local_irk_setf(int elt_idx, int reg_idx, uint16_t localirk)
{
    ASSERT_ERR(reg_idx <= 7);
 ...
 * </pre>
 */
#define BLE_RAL_LOCAL_RPA_ADDR   (0x4000602E + EM_BLE_RAL_OFFSET)
#define BLE_RAL_LOCAL_RPA_INDEX  0x00000017
#define BLE_RAL_LOCAL_RPA_RESET  0x00000000
#define BLE_RAL_LOCAL_RPA_COUNT  3

__BLE_INLINE uint16_t ble_ral_local_rpa_get(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 2);
    return EM_BLE_RD(BLE_RAL_LOCAL_RPA_ADDR + elt_idx * REG_BLE_EM_RAL_SIZE + reg_idx * 2);
}

__BLE_INLINE void ble_ral_local_rpa_set(int elt_idx, int reg_idx, uint16_t value)
{
    ASSERT_ERR(reg_idx <= 2);
...
__BLE_INLINE uint16_t ble_local_rpa_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 2);
...
__BLE_INLINE void ble_local_rpa_setf(int elt_idx, int reg_idx, uint16_t localrpa)
{
    ASSERT_ERR(reg_idx <= 2);
