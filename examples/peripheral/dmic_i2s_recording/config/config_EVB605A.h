...
#ifndef _CONFIG_EVB_H_
#define _CONFIG_EVB_H_
...
#define GPIO5_CONFIG                         ((GPIO_PULL_UP)   | (GPIO_PINMUX_DISABLE) | (GPIO_DIR_INPUT)  | (GPIO_INPUT_NOPULL))
...
#define GPIO15_CONFIG                        ((GPIO_PULL_DOWN) | (GPIO_PINMUX_ENABLE)  | (GPIO_DIR_INPUT)  | (GPIO_INPUT_NOPULL))
...
#define GPIO26_CONFIG                        ((GPIO_PULL_UP) | (GPIO_PINMUX_ENABLE) | (GPIO_DIR_INPUT) | (GPIO_INPUT_NOPULL))
#define GPIO27_CONFIG                        ((GPIO_PULL_UP) | (GPIO_PINMUX_ENABLE) | (GPIO_DIR_INPUT) | (GPIO_INPUT_NOPULL))
...
//#define GPIO30_CONFIG                        ((GPIO_PULL_UP) | (GPIO_PINMUX_ENABLE)  | (GPIO_DIR_OUTPUT) | (GPIO_OUTPUT_LOW))
//#define GPIO31_CONFIG                        ((GPIO_PULL_UP) | (GPIO_PINMUX_ENABLE)  | (GPIO_DIR_OUTPUT) | (GPIO_OUTPUT_LOW))
// GPIO Pin Group7
...
// GPIO Pin Group9
#define GPIO_MODE_PINGROUP9                  GPIO_MODE_DMIC
#define GPIO36_CONFIG                        ((GPIO_PULL_DOWN) | (GPIO_PINMUX_ENABLE)  | (GPIO_DIR_OUTPUT) | (GPIO_OUTPUT_HIGH))
#define GPIO37_CONFIG                        ((GPIO_PULL_DOWN) | (GPIO_PINMUX_ENABLE)  | (GPIO_DIR_INPUT)  | (GPIO_INPUT_NOPULL))
