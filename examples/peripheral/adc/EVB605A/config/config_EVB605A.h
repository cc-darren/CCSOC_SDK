...
*   (pick one OLED module from module_supported.h)
...
//#define USE_CC6801_ADC          FALSE
//#define ADC_EXTERNAL_R1_OHM     LIION_BATTERY       //alternate COIN_BATTERY
...
#define GPIO6_CONFIG                         ((GPIO_PULL_DOWN) | (GPIO_PINMUX_ENABLE) | (GPIO_DIR_INPUT)  | (GPIO_INPUT_NOPULL))
