...
#ifndef _CONFIG_DC404A_H_
#define _CONFIG_DC404A_H_
...
#define GPIO20_CONFIG                        ((GPIO_PULL_UP)   | (GPIO_PINMUX_DISABLE) | (GPIO_DIR_INPUT)  | (GPIO_INPUT_NOPULL))
#define GPIO21_CONFIG                        ((GPIO_PULL_UP)   | (GPIO_PINMUX_DISABLE) | (GPIO_DIR_INPUT)  | (GPIO_INPUT_NOPULL))
