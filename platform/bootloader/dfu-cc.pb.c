...
const bool dfu_init_command_encrypt_default = false;
...
const pb_field_t dfu_init_command_fields[11] = {
    ...
    PB_FIELD( 10, BOOL    , OPTIONAL, STATIC  , OTHER, dfu_init_command_t, encrypt, is_debug, &dfu_init_command_encrypt_default),
    PB_LAST_FIELD
};
