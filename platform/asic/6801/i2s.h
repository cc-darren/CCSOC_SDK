...
#define CC6801_I2S_CLKEN_MASTER         (CC6801_I2S_BIT_ENABLE << CC6801_I2S_CLKEN_SHIFT)

// 0x08 - I2S Transmitter Control(I2STXCTL)
#define CC6801_I2S_TXALIGN_SHIFT        14
#define CC6801_I2S_TXALIGN_MASK         (0x3 << CC6801_I2S_TXALIGN_SHIFT)
#define CC6801_I2S_TXALIGN_24BE         (CC6801_I2S_BIT_ALIGN_24BE  << CC6801_I2S_TXALIGN_SHIFT)
#define CC6801_I2S_TXALIGN_24LE         (CC6801_I2S_BIT_ALIGN_24LE << CC6801_I2S_TXALIGN_SHIFT)
#define CC6801_I2S_TXALIGN_16LE	        (CC6801_I2S_BIT_ALIGN_16LE << CC6801_I2S_TXALIGN_SHIFT)
#define CC6801_I2S_TXALIGN_8LE	        (CC6801_I2S_BIT_ALIGN_8LE << CC6801_I2S_TXALIGN_SHIFT)

#define CC6801_I2S_TXRES_SHIFT          2
#define CC6801_I2S_TXRES_MASK           (0x1F << CC6801_I2S_TXRES_SHIFT)
#define CC6801_I2S_TXRES_8              (CC6801_I2S_BITS_8  << CC6801_I2S_TXRES_SHIFT)
#define CC6801_I2S_TXRES_16             (CC6801_I2S_BITS_16 << CC6801_I2S_TXRES_SHIFT)
#define CC6801_I2S_TXRES_20	            (CC6801_I2S_BITS_20 << CC6801_I2S_TXRES_SHIFT)
#define CC6801_I2S_TXRES_24	            (CC6801_I2S_BITS_24 << CC6801_I2S_TXRES_SHIFT)

#define CC6801_I2S_TXMOD_SHIFT          0
#define CC6801_I2S_TXMOD_MASK           (0x3 << CC6801_I2S_TXMOD_SHIFT)
#define CC6801_I2S_TXMOD_I2S            (CC6801_I2S_BIT_FORMAT_I2S << CC6801_I2S_TXMOD_SHIFT)
#define CC6801_I2S_TXMOD_RJM            (CC6801_I2S_BIT_FORMAT_RJM << CC6801_I2S_TXMOD_SHIFT)
#define CC6801_I2S_TXMOD_LJM            (CC6801_I2S_BIT_FORMAT_LJM << CC6801_I2S_TXMOD_SHIFT)
