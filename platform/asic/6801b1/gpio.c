...
int cc6801_gpio_pinmux_init(void)
{
    ...
    //In normal mode, always disable EF_TC pad to save power
    //regGPIOnew->specialPadInEn = 0x18;
    //regGPIOnew->specialPadInEn = 0xFFFFFFFF;
    //In normal mode, always set low drive strength for EF_TC pad
    //regGPIOnew->specialPadDrvStrength = 0x18;
    //regGPIOnew->specialPadDrvStrength = 0xFFFFFFFF;
