...
// AO_CKGEN
#define AOCKGEN_CFG1_REG           (AOCKGEN_ADDR_BASE + 0x00000004)
#define AOCKGEN_CFG2_REG           (AOCKGEN_ADDR_BASE + 0x00000008)
#define AOCKGEN_CFG3_REG           (AOCKGEN_ADDR_BASE + 0x0000000c)
#define AOCKGEN_CFG4_REG           (AOCKGEN_ADDR_BASE + 0x00000010)
#define AOCKGEN_CLKEN_REG          (AOCKGEN_ADDR_BASE + 0x00000014)
#define AOCKGEN_SWRST_REG          (AOCKGEN_ADDR_BASE + 0x00000018)
#define AOCKGEN_BLECLKSEL_REG      (AOCKGEN_ADDR_BASE + 0x0000001c)
...
#define GPIO1_PAD_IN_REG            (GPIO_ADDR_BASE + 0x0000002c)
#define GPIO1_PAD_OUT_REG           (GPIO_ADDR_BASE + 0x00000030)
...
#define HS_PMU_LDOTRIM_REG          (HS_ADDR_BASE + 0x00000038)
#define HS_PMU_DCDC_REG             (HS_ADDR_BASE + 0x0000003C)
#define HS_DR3_PUP_REG              (HS_ADDR_BASE + 0x00000040)
...
typedef volatile struct
{
    ...
    uint32_t dwDr0Pup;
    uint32_t reserved0;
    uint32_t dwDr0PupInt;
    uint32_t dwDr1Pup;
    uint32_t reserved1;
    uint32_t dwDr1PupInt;
    uint32_t dwDr2Pup;
    uint32_t reserved2;
    uint32_t dwDr2PupInt;
...
#define regSPI0         ((S_regSPI         *) SPI0_ADDR_BASE)
#define regSPI1         ((S_regSPI         *) SPI1_ADDR_BASE)
#define regSPI2         ((S_regSPI         *) SPI2_ADDR_BASE)
#define regSPI3         ((S_regSPI         *) SPI3_ADDR_BASE)
...
#define regDMIC         ((S_regDMIC        *) DMIC_ADDR_BASE)
