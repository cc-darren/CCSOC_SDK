...
#ifndef __SPIDISK_H__

#define __SPIDISK_H__
...
/* Create a SPI disk, supplying enough memory to hold N sectors of 512 bytes each */
FF_Disk_t *FF_SPIDiskInit( char *pcName, uint32_t ulSectorCount );

/* Unmount the volume */
BaseType_t FF_SPIDiskUnmount( FF_Disk_t *pDisk );

/* Mount the volume */
BaseType_t FF_SPIDiskMount( FF_Disk_t *pDisk );
...
BaseType_t FF_SPIDiskFormat( FF_Disk_t *pxDisk, BaseType_t aPart );
