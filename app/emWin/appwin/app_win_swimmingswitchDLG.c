...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { WINDOW_CreateIndirect, "app_win_swimmingswitch", ID_WINDOW_0, 0, 0, 176, 176, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "Text_Swimswitch", ID_TEXT_0, 0, 20, 176, 31, 0, 0x64, 0 },
  { IMAGE_CreateIndirect, "Image_Swimswitch", ID_IMAGE_0, 4, 80, 80, 80, 0, 0, 0 },
  { TEXT_CreateIndirect, "Text_Swimswitch", ID_TEXT_1, 92, 80, 80, 80, 0, 0x64, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    //
    // Initialization of 'app_win_swimmingswitch'
    //
    hItem = pMsg->hWin;
    WINDOW_SetBkColor(hItem, GUI_MAKE_COLOR(0x00000000));
    //
    // Initialization of 'Text_Swimswitch'
    //
    hItem = WM_GetDialogItem(pMsg->hWin, ID_TEXT_0);
    TEXT_SetText(hItem, "SWIM SW");
    TEXT_SetTextAlign(hItem, GUI_TA_HCENTER | GUI_TA_VCENTER);
    TEXT_SetFont(hItem, GUI_FONT_32B_ASCII);
    TEXT_SetTextColor(hItem, GUI_MAKE_COLOR(0x0040FF00));
    //
    // Initialization of 'Image_Swimswitch'
    //
...
/*********************************************************************
*
*       Createapp_win_swimmingswitch
*/
WM_HWIN Createapp_win_swimmingswitch(void);
WM_HWIN Createapp_win_swimmingswitch(void) {
  WM_HWIN hWin;
...
WM_HWIN CreateWindow_Swimmingswitch(void);
WM_HWIN CreateWindow_Swimmingswitch(void) {
	WM_HWIN hWin;
