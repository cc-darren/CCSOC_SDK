...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { WINDOW_CreateIndirect, "app_win_incommingsms", ID_WINDOW_0, 0, 0, 176, 176, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "Text_Incommingsms", ID_TEXT_0, 0, 20, 176, 31, 0, 0x64, 0 },
  { IMAGE_CreateIndirect, "Image_Incommingsms", ID_IMAGE_0, 4, 80, 80, 80, 0, 0, 0 },
  { TEXT_CreateIndirect, "Text_Incommingsms", ID_TEXT_1, 92, 80, 80, 80, 0, 0x64, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    //
    // Initialization of 'app_win_incommingsms'
    //
    hItem = pMsg->hWin;
    WINDOW_SetBkColor(hItem, GUI_MAKE_COLOR(0x00000000));
    //
    // Initialization of 'Text_Incommingsms'
    //
    ...
    //
    // Initialization of 'Image_Incommingsms'
    //
...
/*********************************************************************
*
*       Createapp_win_incommingsms
*/
WM_HWIN Createapp_win_incommingsms(void);
WM_HWIN Createapp_win_incommingsms(void) {
  WM_HWIN hWin;
...
WM_HWIN CreateWindow_Incommingsms(void);
WM_HWIN CreateWindow_Incommingsms(void) {
	WM_HWIN hWin;
