...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_PRE_PAINT:
    ...
    break;
  case WM_PAINT:
    //TracerInfo("== WindowDLG WINDOW 1 WM_PAINT ==\r\n");
    GUI_SetBkColor(GUI_CYAN);

    hItem = WM_GetDialogItem(pMsg->hWin, ID_TEXT_0);
    //WM_SetCallback(hItem,_cbText);
	TEXT_SetText(hItem, "Time-1");
  ...
  case WM_POST_PAINT:
    ...
    //JDI_End_Draw();
    break;
  case WM_POST_BANDING:
    //JDI_End_Draw();
    break;

  case WM_TOUCH:
	  APP_SendMessage(ID_USER_TOUCH, PAGE_CLOCK);
	  break;
  case WM_NOTIFY_PARENT:
    ...
    case ID_BUTTON_3: // Notifications sent by 'Button'
      ...
      case WM_NOTIFICATION_CLICKED:
        ...
        break;
      case WM_NOTIFICATION_RELEASED:
		  APP_SendMessage(ID_USER_SLIDE_NEXT, PAGE_CLOCK);
        break;
      // USER START (Optionally insert additional code for further notification handling)
      // USER END
      }
