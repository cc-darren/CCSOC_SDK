...
#ifndef _PROJECT_FPGA_VENUS_H_
#define _PROJECT_FPGA_VENUS_H_
...
/**************************************************
*   Choose PPG sensor and config PPG interface
*   (pick one PPG sensor from module_supported.h)
*   (please select PPG_NULL if PPG is not in use)
*
...
// for PPG interrupt
#define GPIO22_CONFIG                         ((GPIO_PULL_UP) | (GPIO_PINMUX_DISABLE) | (GPIO_DIR_INPUT) | (GPIO_INPUT_NOPULL)) 
