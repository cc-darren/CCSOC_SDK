...
*  Description:
*  ------------
*  Bootloader configuration for EVB
*
*  Author:
*  -------
*  PPP   (CC-pattaya)
...
#ifndef _PROJECT_BOOTLOADER_EVB_H_
#define _PROJECT_BOOTLOADER_EVB_H_
...
#endif // _PROJECT_BOOTLOADER_EVB_H_
