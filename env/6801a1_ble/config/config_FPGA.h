...
#define SYSTEM_CLOCK_MHZ        24      //unit: MHz
...
// <h> BLE - DEVICE NAME
#define APP_DFLT_DEVICE_NAME    "CC6801-99"

// <h> BLE - DEVICE ADDRESS
#define APP_DFLT_DEVICE_ADDR    { 0x99, 0x36, 0x61, 0x45, 0x23, 0x01 }
